...
namespace Org.Encog.Engine.Network.Activation {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationBiPolar']"
	[global::Android.Runtime.Register ("org/encog/engine/network/activation/ActivationBiPolar", DoNotGenerateAcw=true)]
	public partial class ActivationBiPolar : global::Java.Lang.Object, global::Org.Encog.Engine.Network.Activation.IActivationFunction {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/encog/engine/network/activation/ActivationBiPolar", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ActivationBiPolar); }
		}

		protected ActivationBiPolar (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationBiPolar']/constructor[@name='ActivationBiPolar' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ActivationBiPolar ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (ActivationBiPolar)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Org.Encog.Engine.Network.Activation.ActivationBiPolar __this = global::Java.Lang.Object.GetObject<global::Org.Encog.Engine.Network.Activation.ActivationBiPolar> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe bool HasDerivative {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationBiPolar']/method[@name='hasDerivative' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationBiPolar']/method[@name='activationFunction' and count(parameter)=3 and parameter[1][@type='double[]'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationBiPolar']/method[@name='clone' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationBiPolar']/method[@name='derivativeFunction' and count(parameter)=1 and parameter[1][@type='double']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationBiPolar']/method[@name='getOpenCLExpression' and count(parameter)=1 and parameter[1][@type='boolean']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationBiPolar']/method[@name='getParamNames' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationBiPolar']/method[@name='getParams' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationBiPolar']/method[@name='setParam' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='double']]"
