...
namespace Org.Encog.Engine {
	...
	public partial interface IEngineNeuralNetwork : global::Org.Encog.Engine.IEngineMachineLearning {
		...
		int EncodeLength {
			...
			[Register ("getEncodeLength", "()I", "GetGetEncodeLengthHandler:Org.Encog.Engine.IEngineNeuralNetworkInvoker, neuroph_2.5RC2")] get;
		}
		...
		[Register ("decodeNetwork", "([D)V", "GetDecodeNetwork_arrayDHandler:Org.Encog.Engine.IEngineNeuralNetworkInvoker, neuroph_2.5RC2")]
		...
		[Register ("encodeNetwork", "()[D", "GetEncodeNetworkHandler:Org.Encog.Engine.IEngineNeuralNetworkInvoker, neuroph_2.5RC2")]
