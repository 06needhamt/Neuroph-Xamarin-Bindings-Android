...
namespace Org.Encog.Engine.Network.Activation {
	...
	public partial interface IActivationFunction : global::Java.IO.ISerializable, global::Java.Lang.ICloneable {
		...
		bool HasDerivative {
			...
			[Register ("hasDerivative", "()Z", "GetHasDerivativeHandler:Org.Encog.Engine.Network.Activation.IActivationFunctionInvoker, neuroph_2.5RC2")] get;
		}
		...
		[Register ("activationFunction", "([DII)V", "GetActivationFunction_arrayDIIHandler:Org.Encog.Engine.Network.Activation.IActivationFunctionInvoker, neuroph_2.5RC2")]
		...
		[Register ("clone", "()Lorg/encog/engine/network/activation/ActivationFunction;", "GetCloneHandler:Org.Encog.Engine.Network.Activation.IActivationFunctionInvoker, neuroph_2.5RC2")]
		...
		[Register ("derivativeFunction", "(D)D", "GetDerivativeFunction_DHandler:Org.Encog.Engine.Network.Activation.IActivationFunctionInvoker, neuroph_2.5RC2")]
		...
		[Register ("getOpenCLExpression", "(Z)Ljava/lang/String;", "GetGetOpenCLExpression_ZHandler:Org.Encog.Engine.Network.Activation.IActivationFunctionInvoker, neuroph_2.5RC2")]
		...
		[Register ("getParamNames", "()[Ljava/lang/String;", "GetGetParamNamesHandler:Org.Encog.Engine.Network.Activation.IActivationFunctionInvoker, neuroph_2.5RC2")]
		...
		[Register ("getParams", "()[D", "GetGetParamsHandler:Org.Encog.Engine.Network.Activation.IActivationFunctionInvoker, neuroph_2.5RC2")]
		double[] GetParams ();
		...
		[Register ("setParam", "(ID)V", "GetSetParam_IDHandler:Org.Encog.Engine.Network.Activation.IActivationFunctionInvoker, neuroph_2.5RC2")]
