...
namespace Org.Neuroph.Samples.Stockmarket {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockTrainingSetImport']"
	[global::Android.Runtime.Register ("org/neuroph/samples/stockmarket/StockTrainingSetImport", DoNotGenerateAcw=true)]
	public partial class StockTrainingSetImport : global::Org.Neuroph.Util.TrainingSetImport {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/samples/stockmarket/StockTrainingSetImport", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockTrainingSetImport']/constructor[@name='StockTrainingSetImport' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockTrainingSetImport']/method[@name='importFromArray' and count(parameter)=3 and parameter[1][@type='double[]'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
		[Register ("importFromArray", "([DII)Lorg/neuroph/core/learning/TrainingSet;", "")]
