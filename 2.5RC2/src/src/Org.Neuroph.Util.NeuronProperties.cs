...
namespace Org.Neuroph.Util {
	...
	public partial class NeuronProperties : global::Org.Neuroph.Util.Properties {
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.util']/class[@name='NeuronProperties']/constructor[@name='NeuronProperties' and count(parameter)=3 and parameter[1][@type='java.lang.Class'] and parameter[2][@type='java.lang.Class'] and parameter[3][@type='java.lang.Class']]"
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.util']/class[@name='NeuronProperties']/constructor[@name='NeuronProperties' and count(parameter)=4 and parameter[1][@type='java.lang.Class'] and parameter[2][@type='java.lang.Class'] and parameter[3][@type='java.lang.Class'] and parameter[4][@type='java.lang.Class']]"
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (id_ctor_Ljava_lang_Class_Ljava_lang_Class_Ljava_lang_Class_Ljava_lang_Class_ == IntPtr.Zero)
					id_ctor_Ljava_lang_Class_Ljava_lang_Class_Ljava_lang_Class_Ljava_lang_Class_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;)V");
				SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.util']/class[@name='NeuronProperties']/constructor[@name='NeuronProperties' and count(parameter)=2 and parameter[1][@type='java.lang.Class'] and parameter[2][@type='org.neuroph.util.TransferFunctionType']]"
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.util']/class[@name='NeuronProperties']/constructor[@name='NeuronProperties' and count(parameter)=2 and parameter[1][@type='java.lang.Class'] and parameter[2][@type='java.lang.Class']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Lang.Class SummingFunction {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.util']/class[@name='NeuronProperties']/method[@name='getSummingFunction' and count(parameter)=0]"
			[Register ("getSummingFunction", "()Ljava/lang/Class;", "GetGetSummingFunctionHandler")]
			get {
				if (id_getSummingFunction == IntPtr.Zero)
					id_getSummingFunction = JNIEnv.GetMethodID (class_ref, "getSummingFunction", "()Ljava/lang/Class;");
				try {
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Lang.Class WeightsFunction {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.util']/class[@name='NeuronProperties']/method[@name='getWeightsFunction' and count(parameter)=0]"
			[Register ("getWeightsFunction", "()Ljava/lang/Class;", "GetGetWeightsFunctionHandler")]
			get {
				if (id_getWeightsFunction == IntPtr.Zero)
					id_getWeightsFunction = JNIEnv.GetMethodID (class_ref, "getWeightsFunction", "()Ljava/lang/Class;");
				try {
