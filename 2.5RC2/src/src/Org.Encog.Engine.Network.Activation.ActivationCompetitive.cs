...
namespace Org.Encog.Engine.Network.Activation {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationCompetitive']"
	[global::Android.Runtime.Register ("org/encog/engine/network/activation/ActivationCompetitive", DoNotGenerateAcw=true)]
	public partial class ActivationCompetitive : global::Java.Lang.Object, global::Org.Encog.Engine.Network.Activation.IActivationFunction {


		// Metadata.xml XPath field reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationCompetitive']/field[@name='PARAM_COMPETITIVE_MAX_WINNERS']"
		[Register ("PARAM_COMPETITIVE_MAX_WINNERS")]
		public const int ParamCompetitiveMaxWinners = (int) 0;
		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/encog/engine/network/activation/ActivationCompetitive", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ActivationCompetitive); }
		}
...
#pragma warning disable 0169
		...
		{
			global::Org.Encog.Engine.Network.Activation.ActivationCompetitive __this = global::Java.Lang.Object.GetObject<global::Org.Encog.Engine.Network.Activation.ActivationCompetitive> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe bool HasDerivative {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationCompetitive']/method[@name='hasDerivative' and count(parameter)=0]"
		...
		static Delegate cb_getMaxWinners;
#pragma warning disable 0169
		static Delegate GetGetMaxWinnersHandler ()
		{
			if (cb_getMaxWinners == null)
				cb_getMaxWinners = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, int>) n_GetMaxWinners);
			return cb_getMaxWinners;
		}

		static int n_GetMaxWinners (IntPtr jnienv, IntPtr native__this)
		{
			global::Org.Encog.Engine.Network.Activation.ActivationCompetitive __this = global::Java.Lang.Object.GetObject<global::Org.Encog.Engine.Network.Activation.ActivationCompetitive> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.MaxWinners;
		}
#pragma warning restore 0169

		static IntPtr id_getMaxWinners;
		public virtual unsafe int MaxWinners {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationCompetitive']/method[@name='getMaxWinners' and count(parameter)=0]"
			[Register ("getMaxWinners", "()I", "GetGetMaxWinnersHandler")]
			get {
				if (id_getMaxWinners == IntPtr.Zero)
					id_getMaxWinners = JNIEnv.GetMethodID (class_ref, "getMaxWinners", "()I");
				try {
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationCompetitive']/method[@name='activationFunction' and count(parameter)=3 and parameter[1][@type='double[]'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationCompetitive']/method[@name='clone' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationCompetitive']/method[@name='derivativeFunction' and count(parameter)=1 and parameter[1][@type='double']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationCompetitive']/method[@name='getOpenCLExpression' and count(parameter)=1 and parameter[1][@type='boolean']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationCompetitive']/method[@name='getParamNames' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationCompetitive']/method[@name='getParams' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.encog.engine.network.activation']/class[@name='ActivationCompetitive']/method[@name='setParam' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='double']]"
