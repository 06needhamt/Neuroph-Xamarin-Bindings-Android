...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.nnet.learning']/class[@name='UnsupervisedHebbianLearning']/method[@name='adjustWeights' and count(parameter)=0]"
		...
		protected override unsafe void AdjustWeights ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "adjustWeights", "()V"));
			} finally {
			}
		}
