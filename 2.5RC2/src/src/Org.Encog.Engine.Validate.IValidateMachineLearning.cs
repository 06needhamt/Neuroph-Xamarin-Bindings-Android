...
namespace Org.Encog.Engine.Validate {
	...
	public partial interface IValidateMachineLearning : IJavaObject {
		...
		[Register ("isValid", "(Lorg/encog/engine/EngineMachineLearning;)Ljava/lang/String;", "GetIsValid_Lorg_encog_engine_EngineMachineLearning_Handler:Org.Encog.Engine.Validate.IValidateMachineLearningInvoker, neuroph_2.5RC2")]
		...
		[Register ("validate", "(Lorg/encog/engine/EngineMachineLearning;)V", "GetValidate_Lorg_encog_engine_EngineMachineLearning_Handler:Org.Encog.Engine.Validate.IValidateMachineLearningInvoker, neuroph_2.5RC2")]
