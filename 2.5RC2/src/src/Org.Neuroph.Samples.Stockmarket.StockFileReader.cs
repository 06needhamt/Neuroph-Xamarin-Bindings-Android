...
namespace Org.Neuroph.Samples.Stockmarket {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockFileReader']"
	[global::Android.Runtime.Register ("org/neuroph/samples/stockmarket/StockFileReader", DoNotGenerateAcw=true)]
	public partial class StockFileReader : global::Java.Lang.Object {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/samples/stockmarket/StockFileReader", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockFileReader']/constructor[@name='StockFileReader' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockFileReader']/constructor[@name='StockFileReader' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register (".ctor", "(I)V", "")]
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Samples.Stockmarket.StockFileReader __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Samples.Stockmarket.StockFileReader> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe int MaxCounter {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockFileReader']/method[@name='getMaxCounter' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockFileReader']/method[@name='setMaxCounter' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockFileReader']/method[@name='getValuesRow' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockFileReader']/method[@name='read' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockFileReader']/method[@name='setValuesRow' and count(parameter)=1 and parameter[1][@type='java.lang.String[]']]"
