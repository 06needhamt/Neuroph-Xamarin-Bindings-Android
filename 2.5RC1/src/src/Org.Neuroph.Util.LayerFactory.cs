...
namespace Org.Neuroph.Util {
	...
	public partial class LayerFactory : global::Java.Lang.Object {
		...
		static IntPtr id_createLayer_Ljava_util_Vector_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.util']/class[@name='LayerFactory']/method[@name='createLayer' and count(parameter)=1 and parameter[1][@type='java.util.Vector&lt;org.neuroph.util.NeuronProperties&gt;']]"
		[Register ("createLayer", "(Ljava/util/Vector;)Lorg/neuroph/core/Layer;", "")]
