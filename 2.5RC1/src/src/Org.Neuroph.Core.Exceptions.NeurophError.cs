...
namespace Org.Neuroph.Core.Exceptions {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.core.exceptions']/class[@name='NeurophError']"
	[global::Android.Runtime.Register ("org/neuroph/core/exceptions/NeurophError", DoNotGenerateAcw=true)]
	public partial class NeurophError : global::Java.Lang.RuntimeException {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/core/exceptions/NeurophError", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (NeurophError); }
		}

		protected NeurophError (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_Throwable_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.core.exceptions']/class[@name='NeurophError']/constructor[@name='NeurophError' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Throwable']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/Throwable;)V", "")]
		public unsafe NeurophError (string p0, global::Java.Lang.Throwable p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (NeurophError)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.core.exceptions']/class[@name='NeurophError']/constructor[@name='NeurophError' and count(parameter)=1 and parameter[1][@type='java.lang.Throwable']]"
		[Register (".ctor", "(Ljava/lang/Throwable;)V", "")]
		public unsafe NeurophError (global::Java.Lang.Throwable p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.core.exceptions']/class[@name='NeurophError']/constructor[@name='NeurophError' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe NeurophError (string p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.core.exceptions']/class[@name='NeurophError']/constructor[@name='NeurophError' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe NeurophError ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
