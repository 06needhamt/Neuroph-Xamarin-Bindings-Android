...
namespace Org.Neuroph.Core.Transfer {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.core.transfer']/class[@name='Linear']"
	[global::Android.Runtime.Register ("org/neuroph/core/transfer/Linear", DoNotGenerateAcw=true)]
	public partial class Linear : global::Org.Neuroph.Core.Transfer.TransferFunction, global::Java.IO.ISerializable {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/core/transfer/Linear", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (Linear); }
		}

		protected Linear (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lorg_neuroph_util_Properties_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.core.transfer']/class[@name='Linear']/constructor[@name='Linear' and count(parameter)=1 and parameter[1][@type='org.neuroph.util.Properties']]"
		[Register (".ctor", "(Lorg/neuroph/util/Properties;)V", "")]
		public unsafe Linear (global::Org.Neuroph.Util.Properties p0)
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.core.transfer']/class[@name='Linear']/constructor[@name='Linear' and count(parameter)=1 and parameter[1][@type='double']]"
		[Register (".ctor", "(D)V", "")]
		public unsafe Linear (double p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.core.transfer']/class[@name='Linear']/constructor[@name='Linear' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe Linear ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Core.Transfer.Linear __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Transfer.Linear> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.Slope;
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe double Slope {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.transfer']/class[@name='Linear']/method[@name='getSlope' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.transfer']/class[@name='Linear']/method[@name='setSlope' and count(parameter)=1 and parameter[1][@type='double']]"
			...
			set {
				...
				try {
					...
					if (GetType () == ThresholdType)
						JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setSlope_D, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setSlope", "(D)V"), __args);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.transfer']/class[@name='Linear']/method[@name='getOutput' and count(parameter)=1 and parameter[1][@type='double']]"
