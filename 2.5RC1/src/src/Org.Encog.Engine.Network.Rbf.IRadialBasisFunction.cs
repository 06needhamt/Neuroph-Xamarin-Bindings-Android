...
namespace Org.Encog.Engine.Network.Rbf {
	...
	public partial interface IRadialBasisFunction : IJavaObject {
		...
		int Dimensions {
			...
			[Register ("getDimensions", "()I", "GetGetDimensionsHandler:Org.Encog.Engine.Network.Rbf.IRadialBasisFunctionInvoker, neuroph_2.5RC1")] get;
		}
		...
		double Peak {
			...
			[Register ("getPeak", "()D", "GetGetPeakHandler:Org.Encog.Engine.Network.Rbf.IRadialBasisFunctionInvoker, neuroph_2.5RC1")] get;
			...
			[Register ("setPeak", "(D)V", "GetSetPeak_DHandler:Org.Encog.Engine.Network.Rbf.IRadialBasisFunctionInvoker, neuroph_2.5RC1")] set;
		}
		...
		double Width {
			...
			[Register ("getWidth", "()D", "GetGetWidthHandler:Org.Encog.Engine.Network.Rbf.IRadialBasisFunctionInvoker, neuroph_2.5RC1")] get;
			...
			[Register ("setWidth", "(D)V", "GetSetWidth_DHandler:Org.Encog.Engine.Network.Rbf.IRadialBasisFunctionInvoker, neuroph_2.5RC1")] set;
		}
		...
		[Register ("calculate", "([D)D", "GetCalculate_arrayDHandler:Org.Encog.Engine.Network.Rbf.IRadialBasisFunctionInvoker, neuroph_2.5RC1")]
		...
		[Register ("getCenter", "(I)D", "GetGetCenter_IHandler:Org.Encog.Engine.Network.Rbf.IRadialBasisFunctionInvoker, neuroph_2.5RC1")]
		...
		[Register ("getCenters", "()[D", "GetGetCentersHandler:Org.Encog.Engine.Network.Rbf.IRadialBasisFunctionInvoker, neuroph_2.5RC1")]
		double[] GetCenters ();
		...
		[Register ("setCenters", "([D)V", "GetSetCenters_arrayDHandler:Org.Encog.Engine.Network.Rbf.IRadialBasisFunctionInvoker, neuroph_2.5RC1")]
