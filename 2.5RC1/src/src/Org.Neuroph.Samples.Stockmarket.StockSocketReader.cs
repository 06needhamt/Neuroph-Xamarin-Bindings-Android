...
namespace Org.Neuroph.Samples.Stockmarket {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockSocketReader']"
	[global::Android.Runtime.Register ("org/neuroph/samples/stockmarket/StockSocketReader", DoNotGenerateAcw=true)]
	public partial class StockSocketReader : global::Java.Lang.Object, global::Java.Lang.IRunnable {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/samples/stockmarket/StockSocketReader", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockSocketReader']/constructor[@name='StockSocketReader' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register (".ctor", "(I)V", "")]
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockSocketReader']/constructor[@name='StockSocketReader' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Samples.Stockmarket.StockSocketReader __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Samples.Stockmarket.StockSocketReader> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe int MaxCounter {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockSocketReader']/method[@name='getMaxCounter' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockSocketReader']/method[@name='setMaxCounter' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe long Tsleep {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockSocketReader']/method[@name='getTsleep' and count(parameter)=0]"
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return JNIEnv.CallLongMethod  (Handle, id_getTsleep);
					else
						return JNIEnv.CallNonvirtualLongMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getTsleep", "()J"));
				} finally {
				}
			}
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockSocketReader']/method[@name='setTsleep' and count(parameter)=1 and parameter[1][@type='long']]"
			...
			set {
				...
				try {
					...
					if (GetType () == ThresholdType)
						JNIEnv.CallVoidMethod  (Handle, id_setTsleep_J, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setTsleep", "(J)V"), __args);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockSocketReader']/method[@name='getValuesRow' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockSocketReader']/method[@name='run' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.stockmarket']/class[@name='StockSocketReader']/method[@name='setValuesRow' and count(parameter)=1 and parameter[1][@type='java.lang.String[]']]"
