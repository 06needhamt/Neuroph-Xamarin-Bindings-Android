...
namespace Org.Neuroph.Nnet.Comp {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.nnet.comp']/class[@name='DelayedNeuron']"
	[global::Android.Runtime.Register ("org/neuroph/nnet/comp/DelayedNeuron", DoNotGenerateAcw=true)]
	public partial class DelayedNeuron : global::Org.Neuroph.Core.Neuron {


		static IntPtr outputHistory_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='org.neuroph.nnet.comp']/class[@name='DelayedNeuron']/field[@name='outputHistory']"
		[Register ("outputHistory")]
		protected global::Java.Util.Vector OutputHistory {
			get {
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/nnet/comp/DelayedNeuron", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.nnet.comp']/class[@name='DelayedNeuron']/constructor[@name='DelayedNeuron' and count(parameter)=2 and parameter[1][@type='org.neuroph.core.input.InputFunction'] and parameter[2][@type='org.neuroph.core.transfer.TransferFunction']]"
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Nnet.Comp.DelayedNeuron __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Nnet.Comp.DelayedNeuron> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.GetOutput (p0);
		}
#pragma warning restore 0169

		static IntPtr id_getOutput_I;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.nnet.comp']/class[@name='DelayedNeuron']/method[@name='getOutput' and count(parameter)=1 and parameter[1][@type='int']]"
