...
namespace Org.Encog.Engine {
	...
	public partial interface IEngineMachineLearning : IJavaObject {
		...
		int InputCount {
			...
			[Register ("getInputCount", "()I", "GetGetInputCountHandler:Org.Encog.Engine.IEngineMachineLearningInvoker, neuroph_2.5RC1")] get;
		}
		...
		int OutputCount {
			...
			[Register ("getOutputCount", "()I", "GetGetOutputCountHandler:Org.Encog.Engine.IEngineMachineLearningInvoker, neuroph_2.5RC1")] get;
		}
		...
		[Register ("compute", "([D[D)V", "GetCompute_arrayDarrayDHandler:Org.Encog.Engine.IEngineMachineLearningInvoker, neuroph_2.5RC1")]
