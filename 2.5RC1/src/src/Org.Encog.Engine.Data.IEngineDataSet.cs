...
namespace Org.Encog.Engine.Data {
	...
	public partial interface IEngineDataSet : IJavaObject {
		...
		int IdealSize {
			...
			[Register ("getIdealSize", "()I", "GetGetIdealSizeHandler:Org.Encog.Engine.Data.IEngineDataSetInvoker, neuroph_2.5RC1")] get;
		}
		...
		int InputSize {
			...
			[Register ("getInputSize", "()I", "GetGetInputSizeHandler:Org.Encog.Engine.Data.IEngineDataSetInvoker, neuroph_2.5RC1")] get;
		}
		...
		bool IsSupervised {
			...
			[Register ("isSupervised", "()Z", "GetIsSupervisedHandler:Org.Encog.Engine.Data.IEngineDataSetInvoker, neuroph_2.5RC1")] get;
		}
