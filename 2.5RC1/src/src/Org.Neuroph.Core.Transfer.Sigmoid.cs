...
namespace Org.Neuroph.Core.Transfer {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.core.transfer']/class[@name='Sigmoid']"
	[global::Android.Runtime.Register ("org/neuroph/core/transfer/Sigmoid", DoNotGenerateAcw=true)]
	public partial class Sigmoid : global::Org.Neuroph.Core.Transfer.TransferFunction, global::Java.IO.ISerializable {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/core/transfer/Sigmoid", ref java_class_handle);
			}
		}
		...
		public unsafe Sigmoid (global::Org.Neuroph.Util.Properties p0)
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.core.transfer']/class[@name='Sigmoid']/constructor[@name='Sigmoid' and count(parameter)=1 and parameter[1][@type='double']]"
		[Register (".ctor", "(D)V", "")]
		public unsafe Sigmoid (double p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Core.Transfer.Sigmoid __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Transfer.Sigmoid> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.Slope;
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe double Slope {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.transfer']/class[@name='Sigmoid']/method[@name='getSlope' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.transfer']/class[@name='Sigmoid']/method[@name='setSlope' and count(parameter)=1 and parameter[1][@type='double']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.transfer']/class[@name='Sigmoid']/method[@name='getOutput' and count(parameter)=1 and parameter[1][@type='double']]"
