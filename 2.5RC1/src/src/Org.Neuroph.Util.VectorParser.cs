...
namespace Org.Neuroph.Util {
	...
	public partial class VectorParser : global::Java.Lang.Object {
		...
		static IntPtr id_convertToArray_Ljava_util_List_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.util']/class[@name='VectorParser']/method[@name='convertToArray' and count(parameter)=1 and parameter[1][@type='java.util.List&lt;java.lang.Double&gt;']]"
		[Register ("convertToArray", "(Ljava/util/List;)[D", "")]
		public static unsafe double[] ConvertToArray (global::System.Collections.Generic.IList<global::Java.Lang.Double> p0)
		{
			if (id_convertToArray_Ljava_util_List_ == IntPtr.Zero)
				id_convertToArray_Ljava_util_List_ = JNIEnv.GetStaticMethodID (class_ref, "convertToArray", "(Ljava/util/List;)[D");
			IntPtr native_p0 = global::Android.Runtime.JavaList<global::Java.Lang.Double>.ToLocalJniHandle (p0);
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (native_p0);
				double[] __ret = (double[]) JNIEnv.GetArray (JNIEnv.CallStaticObjectMethod  (class_ref, id_convertToArray_Ljava_util_List_, __args), JniHandleOwnership.TransferLocalRef, typeof (double));
				return __ret;
			} finally {
