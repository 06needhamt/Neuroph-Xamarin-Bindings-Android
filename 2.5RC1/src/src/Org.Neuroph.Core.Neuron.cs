		...
		public virtual unsafe global::Java.Util.Vector WeightsVector {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return global::Java.Lang.Object.GetObject<global::Java.Util.Vector> (JNIEnv.CallObjectMethod  (Handle, id_getWeightsVector), JniHandleOwnership.TransferLocalRef);
					else
						return global::Java.Lang.Object.GetObject<global::Java.Util.Vector> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getWeightsVector", "()Ljava/util/Vector;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
