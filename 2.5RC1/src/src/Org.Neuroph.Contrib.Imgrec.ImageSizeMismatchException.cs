...
namespace Org.Neuroph.Contrib.Imgrec {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.contrib.imgrec']/class[@name='ImageSizeMismatchException']"
	[global::Android.Runtime.Register ("org/neuroph/contrib/imgrec/ImageSizeMismatchException", DoNotGenerateAcw=true)]
	public partial class ImageSizeMismatchException : global::Java.Lang.RuntimeException {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/contrib/imgrec/ImageSizeMismatchException", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.contrib.imgrec']/class[@name='ImageSizeMismatchException']/constructor[@name='ImageSizeMismatchException' and count(parameter)=1 and parameter[1][@type='java.lang.Throwable']]"
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.contrib.imgrec']/class[@name='ImageSizeMismatchException']/constructor[@name='ImageSizeMismatchException' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Throwable']]"
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.contrib.imgrec']/class[@name='ImageSizeMismatchException']/constructor[@name='ImageSizeMismatchException' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.contrib.imgrec']/class[@name='ImageSizeMismatchException']/constructor[@name='ImageSizeMismatchException' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
