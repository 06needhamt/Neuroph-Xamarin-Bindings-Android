...
namespace Org.Encog.Engine.Network.Train {
	...
	public partial interface ITrainFlatNetwork : IJavaObject {
		...
		double Error {
			...
			[Register ("getError", "()D", "GetGetErrorHandler:Org.Encog.Engine.Network.Train.ITrainFlatNetworkInvoker, neuroph_2.5RC1")] get;
		}
		...
		int Iteration {
			...
			[Register ("getIteration", "()I", "GetGetIterationHandler:Org.Encog.Engine.Network.Train.ITrainFlatNetworkInvoker, neuroph_2.5RC1")] get;
			...
			[Register ("setIteration", "(I)V", "GetSetIteration_IHandler:Org.Encog.Engine.Network.Train.ITrainFlatNetworkInvoker, neuroph_2.5RC1")] set;
		}
		...
		global::Org.Encog.Engine.Network.Flat.FlatNetwork Network {
			...
			[Register ("getNetwork", "()Lorg/encog/engine/network/flat/FlatNetwork;", "GetGetNetworkHandler:Org.Encog.Engine.Network.Train.ITrainFlatNetworkInvoker, neuroph_2.5RC1")] get;
		}
		...
		int NumThreads {
			...
			[Register ("getNumThreads", "()I", "GetGetNumThreadsHandler:Org.Encog.Engine.Network.Train.ITrainFlatNetworkInvoker, neuroph_2.5RC1")] get;
			...
			[Register ("setNumThreads", "(I)V", "GetSetNumThreads_IHandler:Org.Encog.Engine.Network.Train.ITrainFlatNetworkInvoker, neuroph_2.5RC1")] set;
		}
		...
		global::Org.Encog.Engine.Data.IEngineDataSet Training {
			...
			[Register ("getTraining", "()Lorg/encog/engine/data/EngineDataSet;", "GetGetTrainingHandler:Org.Encog.Engine.Network.Train.ITrainFlatNetworkInvoker, neuroph_2.5RC1")] get;
		}
		...
		[Register ("finishTraining", "()V", "GetFinishTrainingHandler:Org.Encog.Engine.Network.Train.ITrainFlatNetworkInvoker, neuroph_2.5RC1")]
		void FinishTraining ();
		...
		[Register ("iteration", "()V", "GetInvokeIterationHandler:Org.Encog.Engine.Network.Train.ITrainFlatNetworkInvoker, neuroph_2.5RC1")]
		...
		[Register ("iteration", "(I)V", "GetInvokeIteration_IHandler:Org.Encog.Engine.Network.Train.ITrainFlatNetworkInvoker, neuroph_2.5RC1")]
