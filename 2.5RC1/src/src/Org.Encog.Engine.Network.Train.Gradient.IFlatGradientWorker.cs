...
namespace Org.Encog.Engine.Network.Train.Gradient {
	...
	public partial interface IFlatGradientWorker : global::Org.Encog.Engine.Concurrency.IEngineTask {
		...
		long ElapsedTime {
			...
			[Register ("getElapsedTime", "()J", "GetGetElapsedTimeHandler:Org.Encog.Engine.Network.Train.Gradient.IFlatGradientWorkerInvoker, neuroph_2.5RC1")] get;
		}
		...
		global::Org.Encog.Engine.Network.Flat.FlatNetwork Network {
			...
			[Register ("getNetwork", "()Lorg/encog/engine/network/flat/FlatNetwork;", "GetGetNetworkHandler:Org.Encog.Engine.Network.Train.Gradient.IFlatGradientWorkerInvoker, neuroph_2.5RC1")] get;
		}
		...
		[Register ("getWeights", "()[D", "GetGetWeightsHandler:Org.Encog.Engine.Network.Train.Gradient.IFlatGradientWorkerInvoker, neuroph_2.5RC1")]
		double[] GetWeights ();
