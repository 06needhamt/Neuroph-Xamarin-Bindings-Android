...
namespace Org.Neuroph.Util.Plugins {
	...
	public partial class PluginBase : global::Java.Lang.Object, global::Java.IO.ISerializable {
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.util.plugins']/class[@name='PluginBase']/constructor[@name='PluginBase' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe PluginBase ()
