...
namespace Org.Neuroph.Util {
	...
	public partial class TrainingSetImport : global::Java.Lang.Object {
		...
		[Register ("importFromFile", "(Ljava/lang/String;IILjava/lang/String;)Lorg/neuroph/core/data/DataSet;", "")]
		public static unsafe global::Org.Neuroph.Core.Data.DataSet ImportFromFile (string p0, int p1, int p2, string p3)
		{
			if (id_importFromFile_Ljava_lang_String_IILjava_lang_String_ == IntPtr.Zero)
				id_importFromFile_Ljava_lang_String_IILjava_lang_String_ = JNIEnv.GetStaticMethodID (class_ref, "importFromFile", "(Ljava/lang/String;IILjava/lang/String;)Lorg/neuroph/core/data/DataSet;");
			...
			try {
				...
				global::Org.Neuroph.Core.Data.DataSet __ret = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Data.DataSet> (JNIEnv.CallStaticObjectMethod  (class_ref, id_importFromFile_Ljava_lang_String_IILjava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
