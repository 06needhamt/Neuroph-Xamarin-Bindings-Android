...
namespace Org.Neuroph.Util.IO {
	...
	public partial interface IOutputAdapter : IJavaObject {
		...
		[Register ("close", "()V", "GetCloseHandler:Org.Neuroph.Util.IO.IOutputAdapterInvoker, neuroph_2.8")]
		void Close ();
		...
		[Register ("writeOutput", "([D)V", "GetWriteOutput_arrayDHandler:Org.Neuroph.Util.IO.IOutputAdapterInvoker, neuroph_2.8")]
