...
namespace Org.Neuroph.Core.Data.Sample {

	// Metadata.xml XPath interface reference: path="/api/package[@name='org.neuroph.core.data.sample']/interface[@name='Sampling']"
	[Register ("org/neuroph/core/data/sample/Sampling", "", "Org.Neuroph.Core.Data.Sample.ISamplingInvoker")]
	public partial interface ISampling : IJavaObject {

		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.data.sample']/interface[@name='Sampling']/method[@name='sample' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.data.DataSet']]"
		[Register ("sample", "(Lorg/neuroph/core/data/DataSet;)[Lorg/neuroph/core/data/DataSet;", "GetSample_Lorg_neuroph_core_data_DataSet_Handler:Org.Neuroph.Core.Data.Sample.ISamplingInvoker, neuroph_2.8")]
		global::Org.Neuroph.Core.Data.DataSet[] Sample (global::Org.Neuroph.Core.Data.DataSet p0);

	}

	[global::Android.Runtime.Register ("org/neuroph/core/data/sample/Sampling", DoNotGenerateAcw=true)]
	internal class ISamplingInvoker : global::Java.Lang.Object, ISampling {

		static IntPtr java_class_ref = JNIEnv.FindClass ("org/neuroph/core/data/sample/Sampling");
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "org.neuroph.core.data.sample.Sampling"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Core.Data.Sample.ISampling __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Data.Sample.ISampling> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
