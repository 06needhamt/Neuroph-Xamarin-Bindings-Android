...
namespace Org.Neuroph.Core.Input {
	...
	public partial class Difference : global::Org.Neuroph.Core.Input.InputFunction, global::Java.IO.ISerializable {
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.input']/class[@name='Difference']/method[@name='getOutput' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.Connection[]']]"
