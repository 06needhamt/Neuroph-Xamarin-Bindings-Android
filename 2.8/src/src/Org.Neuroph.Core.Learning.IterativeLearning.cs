...
namespace Org.Neuroph.Core.Learning {
	...
	public abstract partial class IterativeLearning : global::Org.Neuroph.Core.Learning.LearningRule, global::Java.IO.ISerializable {
		...
		static IntPtr stopConditions_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='IterativeLearning']/field[@name='stopConditions']"
		[Register ("stopConditions")]
		protected global::System.Collections.IList StopConditions {
			get {
				if (stopConditions_jfieldId == IntPtr.Zero)
					stopConditions_jfieldId = JNIEnv.GetFieldID (class_ref, "stopConditions", "Ljava/util/List;");
				IntPtr __ret = JNIEnv.GetObjectField (((global::Java.Lang.Object) this).Handle, stopConditions_jfieldId);
			...
			set {
				...
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, stopConditions_jfieldId, native_value);
				} finally {
...
#pragma warning restore 0169
		...
		protected virtual unsafe bool HasReachedStopCondition {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='IterativeLearning']/method[@name='hasReachedStopCondition' and count(parameter)=0]"
		...
		static Delegate cb_isIterationsLimited;
#pragma warning disable 0169
		static Delegate GetIsIterationsLimitedHandler ()
		{
			if (cb_isIterationsLimited == null)
				cb_isIterationsLimited = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, bool>) n_IsIterationsLimited);
			return cb_isIterationsLimited;
		}

		static bool n_IsIterationsLimited (IntPtr jnienv, IntPtr native__this)
		{
			global::Org.Neuroph.Core.Learning.IterativeLearning __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.IterativeLearning> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.IsIterationsLimited;
		}
#pragma warning restore 0169

		static IntPtr id_isIterationsLimited;
		public virtual unsafe bool IsIterationsLimited {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='IterativeLearning']/method[@name='isIterationsLimited' and count(parameter)=0]"
			[Register ("isIterationsLimited", "()Z", "GetIsIterationsLimitedHandler")]
			get {
				if (id_isIterationsLimited == IntPtr.Zero)
					id_isIterationsLimited = JNIEnv.GetMethodID (class_ref, "isIterationsLimited", "()Z");
				try {

					if (GetType () == ThresholdType)
						return JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_isIterationsLimited);
					else
						return JNIEnv.CallNonvirtualBooleanMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "isIterationsLimited", "()Z"));
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe int MaxIterations {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='IterativeLearning']/method[@name='getMaxIterations' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		protected virtual unsafe void AfterEpoch ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_afterEpoch);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "afterEpoch", "()V"));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		protected virtual unsafe void BeforeEpoch ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_beforeEpoch);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "beforeEpoch", "()V"));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='IterativeLearning']/method[@name='doLearningEpoch' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.data.DataSet']]"
		...
		static Delegate cb_doOneLearningIteration_Lorg_neuroph_core_data_DataSet_;
#pragma warning disable 0169
		static Delegate GetDoOneLearningIteration_Lorg_neuroph_core_data_DataSet_Handler ()
		{
			if (cb_doOneLearningIteration_Lorg_neuroph_core_data_DataSet_ == null)
				cb_doOneLearningIteration_Lorg_neuroph_core_data_DataSet_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_DoOneLearningIteration_Lorg_neuroph_core_data_DataSet_);
			return cb_doOneLearningIteration_Lorg_neuroph_core_data_DataSet_;
		}

		static void n_DoOneLearningIteration_Lorg_neuroph_core_data_DataSet_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Org.Neuroph.Core.Learning.IterativeLearning __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.IterativeLearning> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Org.Neuroph.Core.Data.DataSet p0 = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Data.DataSet> (native_p0, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		static IntPtr id_doOneLearningIteration_Lorg_neuroph_core_data_DataSet_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='IterativeLearning']/method[@name='doOneLearningIteration' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.data.DataSet']]"
		[Register ("doOneLearningIteration", "(Lorg/neuroph/core/data/DataSet;)V", "GetDoOneLearningIteration_Lorg_neuroph_core_data_DataSet_Handler")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='IterativeLearning']/method[@name='learn' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.data.DataSet']]"
		[Register ("learn", "(Lorg/neuroph/core/data/DataSet;)V", "")]
		public override sealed unsafe void Learn (global::Org.Neuroph.Core.Data.DataSet p0)
		{
		...
		static Delegate cb_learn_Lorg_neuroph_core_data_DataSet_I;
#pragma warning disable 0169
		static Delegate GetLearn_Lorg_neuroph_core_data_DataSet_IHandler ()
		{
			if (cb_learn_Lorg_neuroph_core_data_DataSet_I == null)
				cb_learn_Lorg_neuroph_core_data_DataSet_I = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr, int>) n_Learn_Lorg_neuroph_core_data_DataSet_I);
			return cb_learn_Lorg_neuroph_core_data_DataSet_I;
		}
...
#pragma warning restore 0169
		...
		static IntPtr id_learn_Lorg_neuroph_core_data_DataSet_I;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='IterativeLearning']/method[@name='learn' and count(parameter)=2 and parameter[1][@type='org.neuroph.core.data.DataSet'] and parameter[2][@type='int']]"
		[Register ("learn", "(Lorg/neuroph/core/data/DataSet;I)V", "GetLearn_Lorg_neuroph_core_data_DataSet_IHandler")]
		public virtual unsafe void Learn (global::Org.Neuroph.Core.Data.DataSet p0, int p1)
		{
			if (id_learn_Lorg_neuroph_core_data_DataSet_I == IntPtr.Zero)
				id_learn_Lorg_neuroph_core_data_DataSet_I = JNIEnv.GetMethodID (class_ref, "learn", "(Lorg/neuroph/core/data/DataSet;I)V");
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_learn_Lorg_neuroph_core_data_DataSet_I, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "learn", "(Lorg/neuroph/core/data/DataSet;I)V"), __args);
			} finally {
			}
		}
