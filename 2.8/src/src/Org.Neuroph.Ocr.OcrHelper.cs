...
namespace Org.Neuroph.Ocr {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.ocr']/class[@name='OcrHelper']"
	[global::Android.Runtime.Register ("org/neuroph/ocr/OcrHelper", DoNotGenerateAcw=true)]
	public partial class OcrHelper : global::Org.Neuroph.Imgrec.ImageRecognitionHelper {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/ocr/OcrHelper", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.ocr']/class[@name='OcrHelper']/constructor[@name='OcrHelper' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.ocr']/class[@name='OcrHelper']/method[@name='createNewNeuralNetwork' and count(parameter)=6 and parameter[1][@type='java.lang.String'] and parameter[2][@type='org.neuroph.imgrec.image.Dimension'] and parameter[3][@type='org.neuroph.imgrec.ColorMode'] and parameter[4][@type='java.util.List&lt;java.lang.String&gt;'] and parameter[5][@type='java.util.List&lt;java.lang.Integer&gt;'] and parameter[6][@type='org.neuroph.util.TransferFunctionType']]"
