...
namespace Org.Neuroph.Core {
	...
	public partial class Layer : global::Java.Lang.Object, global::Java.IO.ISerializable {
		...
		static IntPtr neurons_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='org.neuroph.core']/class[@name='Layer']/field[@name='neurons']"
		[Register ("neurons")]
		protected IList<Org.Neuroph.Core.Neuron> Neurons {
			get {
				if (neurons_jfieldId == IntPtr.Zero)
					neurons_jfieldId = JNIEnv.GetFieldID (class_ref, "neurons", "[Lorg/neuroph/core/Neuron;");
				return global::Android.Runtime.JavaArray<global::Org.Neuroph.Core.Neuron>.FromJniHandle (JNIEnv.GetObjectField (((global::Java.Lang.Object) this).Handle, neurons_jfieldId), JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (neurons_jfieldId == IntPtr.Zero)
					neurons_jfieldId = JNIEnv.GetFieldID (class_ref, "neurons", "[Lorg/neuroph/core/Neuron;");
				IntPtr native_value = global::Android.Runtime.JavaArray<global::Org.Neuroph.Core.Neuron>.ToLocalJniHandle (value);
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, neurons_jfieldId, native_value);
				} finally {
...
#pragma warning restore 0169
		...
		public unsafe void AddNeuron (int p0, global::Org.Neuroph.Core.Neuron p1)
		{
			...
			try {
				...
				__args [0] = new JValue (p0);
				__args [1] = new JValue (p1);
				JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_addNeuron_ILorg_neuroph_core_Neuron_, __args);
			} finally {
			}
		}
		...
		public unsafe void AddNeuron (global::Org.Neuroph.Core.Neuron p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_addNeuron_Lorg_neuroph_core_Neuron_, __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Org.Neuroph.Core.Neuron GetNeuronAt (int p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Neuron> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getNeuronAt_I, __args), JniHandleOwnership.TransferLocalRef);
				else
					return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Neuron> (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getNeuronAt", "(I)Lorg/neuroph/core/Neuron;"), __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
		...
		public unsafe global::Org.Neuroph.Core.Neuron[] GetNeurons ()
		{
			...
			try {
				return (global::Org.Neuroph.Core.Neuron[]) JNIEnv.GetArray (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getNeurons), JniHandleOwnership.TransferLocalRef, typeof (global::Org.Neuroph.Core.Neuron));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core']/class[@name='Layer']/method[@name='randomizeWeights' and count(parameter)=1 and parameter[1][@type='java.util.Random']]"
		...
		static Delegate cb_removeAllNeurons;
#pragma warning disable 0169
		static Delegate GetRemoveAllNeuronsHandler ()
		{
			if (cb_removeAllNeurons == null)
				cb_removeAllNeurons = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr>) n_RemoveAllNeurons);
			return cb_removeAllNeurons;
		}

		static void n_RemoveAllNeurons (IntPtr jnienv, IntPtr native__this)
		{
			global::Org.Neuroph.Core.Layer __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Layer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.RemoveAllNeurons ();
		}
#pragma warning restore 0169
		...
		[Register ("removeAllNeurons", "()V", "GetRemoveAllNeuronsHandler")]
		public virtual unsafe void RemoveAllNeurons ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_removeAllNeurons);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "removeAllNeurons", "()V"));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void RemoveNeuron (global::Org.Neuroph.Core.Neuron p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_removeNeuron_Lorg_neuroph_core_Neuron_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "removeNeuron", "(Lorg/neuroph/core/Neuron;)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void RemoveNeuronAt (int p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_removeNeuronAt_I, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "removeNeuronAt", "(I)V"), __args);
			} finally {
			}
		}
