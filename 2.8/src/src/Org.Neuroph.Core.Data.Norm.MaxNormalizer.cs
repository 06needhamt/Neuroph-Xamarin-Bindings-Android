...
namespace Org.Neuroph.Core.Data.Norm {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.core.data.norm']/class[@name='MaxNormalizer']"
	[global::Android.Runtime.Register ("org/neuroph/core/data/norm/MaxNormalizer", DoNotGenerateAcw=true)]
	public partial class MaxNormalizer : global::Java.Lang.Object, global::Org.Neuroph.Core.Data.Norm.INormalizer {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/core/data/norm/MaxNormalizer", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.core.data.norm']/class[@name='MaxNormalizer']/constructor[@name='MaxNormalizer' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Core.Data.Norm.MaxNormalizer __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Data.Norm.MaxNormalizer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.data.norm']/class[@name='MaxNormalizer']/method[@name='normalize' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.data.DataSet']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.data.norm']/class[@name='MaxNormalizer']/method[@name='normalizeMax' and count(parameter)=2 and parameter[1][@type='double[]'] and parameter[2][@type='double[]']]"
		...
		public virtual unsafe double[] NormalizeMax (double[] p0, double[] p1)
		{
			...
			try {
				...
				double[] __ret;
				if (GetType () == ThresholdType)
					__ret = (double[]) JNIEnv.GetArray (JNIEnv.CallObjectMethod  (Handle, id_normalizeMax_arrayDarrayD, __args), JniHandleOwnership.TransferLocalRef, typeof (double));
				else
					__ret = (double[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "normalizeMax", "([D[D)[D"), __args), JniHandleOwnership.TransferLocalRef, typeof (double));
				return __ret;
			} finally {
				if (p0 != null) {
