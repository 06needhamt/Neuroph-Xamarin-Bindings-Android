		...
		public virtual unsafe global::Org.Neuroph.Nnet.Comp.Neuron.CompetitiveNeuron Winner {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Nnet.Comp.Neuron.CompetitiveNeuron> (JNIEnv.CallObjectMethod  (Handle, id_getWinner), JniHandleOwnership.TransferLocalRef);
					else
						return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Nnet.Comp.Neuron.CompetitiveNeuron> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getWinner", "()Lorg/neuroph/nnet/comp/neuron/CompetitiveNeuron;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
