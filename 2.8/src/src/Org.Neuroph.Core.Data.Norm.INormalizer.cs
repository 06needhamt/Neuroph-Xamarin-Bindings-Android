...
namespace Org.Neuroph.Core.Data.Norm {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='org.neuroph.core.data.norm']/interface[@name='Normalizer']"
	[Register ("org/neuroph/core/data/norm/Normalizer", "", "Org.Neuroph.Core.Data.Norm.INormalizerInvoker")]
	public partial interface INormalizer : IJavaObject {

		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.data.norm']/interface[@name='Normalizer']/method[@name='normalize' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.data.DataSet']]"
		[Register ("normalize", "(Lorg/neuroph/core/data/DataSet;)V", "GetNormalize_Lorg_neuroph_core_data_DataSet_Handler:Org.Neuroph.Core.Data.Norm.INormalizerInvoker, neuroph_2.8")]
		void Normalize (global::Org.Neuroph.Core.Data.DataSet p0);

	}

	[global::Android.Runtime.Register ("org/neuroph/core/data/norm/Normalizer", DoNotGenerateAcw=true)]
	internal class INormalizerInvoker : global::Java.Lang.Object, INormalizer {

		static IntPtr java_class_ref = JNIEnv.FindClass ("org/neuroph/core/data/norm/Normalizer");
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "org.neuroph.core.data.norm.Normalizer"));
			return handle;
		}
