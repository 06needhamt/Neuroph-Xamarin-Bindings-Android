...
namespace Org.Neuroph.Imgrec {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.imgrec']/class[@name='FractionRgbData']"
	[global::Android.Runtime.Register ("org/neuroph/imgrec/FractionRgbData", DoNotGenerateAcw=true)]
	public partial class FractionRgbData : global::Java.Lang.Object {


		static IntPtr blueValues_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='org.neuroph.imgrec']/class[@name='FractionRgbData']/field[@name='blueValues']"
		[Register ("blueValues")]
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='org.neuroph.imgrec']/class[@name='FractionRgbData']/field[@name='flattenedRgbValues']"
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='org.neuroph.imgrec']/class[@name='FractionRgbData']/field[@name='greenValues']"
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='org.neuroph.imgrec']/class[@name='FractionRgbData']/field[@name='redValues']"
		[Register ("redValues")]
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/imgrec/FractionRgbData", ref java_class_handle);
			}
		}
		...
		static IntPtr id_ctor_Lorg_neuroph_imgrec_image_Image_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.imgrec']/class[@name='FractionRgbData']/constructor[@name='FractionRgbData' and count(parameter)=1 and parameter[1][@type='org.neuroph.imgrec.image.Image']]"
		[Register (".ctor", "(Lorg/neuroph/imgrec/image/Image;)V", "")]
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (id_ctor_Lorg_neuroph_imgrec_image_Image_ == IntPtr.Zero)
					id_ctor_Lorg_neuroph_imgrec_image_Image_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lorg/neuroph/imgrec/image/Image;)V");
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Imgrec.FractionRgbData __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Imgrec.FractionRgbData> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe int Height {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.imgrec']/class[@name='FractionRgbData']/method[@name='getHeight' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int Width {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.imgrec']/class[@name='FractionRgbData']/method[@name='getWidth' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.imgrec']/class[@name='FractionRgbData']/method[@name='convertRgbInputToBinaryBlackAndWhite' and count(parameter)=1 and parameter[1][@type='double[]']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.imgrec']/class[@name='FractionRgbData']/method[@name='getBlueValues' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.imgrec']/class[@name='FractionRgbData']/method[@name='getFlattenedRgbValues' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.imgrec']/class[@name='FractionRgbData']/method[@name='getGreenValues' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.imgrec']/class[@name='FractionRgbData']/method[@name='getRedValues' and count(parameter)=0]"
		...
		static IntPtr id_populateRGBArrays_Lorg_neuroph_imgrec_image_Image_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.imgrec']/class[@name='FractionRgbData']/method[@name='populateRGBArrays' and count(parameter)=1 and parameter[1][@type='org.neuroph.imgrec.image.Image']]"
		[Register ("populateRGBArrays", "(Lorg/neuroph/imgrec/image/Image;)V", "")]
		protected unsafe void PopulateRGBArrays (global::Org.Neuroph.Imgrec.Image.IImage p0)
		{
			if (id_populateRGBArrays_Lorg_neuroph_imgrec_image_Image_ == IntPtr.Zero)
				id_populateRGBArrays_Lorg_neuroph_imgrec_image_Image_ = JNIEnv.GetMethodID (class_ref, "populateRGBArrays", "(Lorg/neuroph/imgrec/image/Image;)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
