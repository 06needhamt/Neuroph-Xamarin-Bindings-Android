...
namespace Org.Neuroph.Core.Input {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.core.input']/class[@name='Product']"
	[global::Android.Runtime.Register ("org/neuroph/core/input/Product", DoNotGenerateAcw=true)]
	public partial class Product : global::Org.Neuroph.Core.Input.InputFunction, global::Java.IO.ISerializable {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/core/input/Product", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.core.input']/class[@name='Product']/constructor[@name='Product' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe Product ()
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Core.Input.Product __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Input.Product> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.input']/class[@name='Product']/method[@name='getOutput' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.Connection[]']]"
