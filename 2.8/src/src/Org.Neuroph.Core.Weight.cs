	...
	public partial class Weight : global::Java.Lang.Object, global::Java.IO.ISerializable {
		...
		public double WeightChange {
			get {
				...
				return JNIEnv.GetDoubleField (((global::Java.Lang.Object) this).Handle, weightChange_jfieldId);
			}
			set {
				if (weightChange_jfieldId == IntPtr.Zero)
					weightChange_jfieldId = JNIEnv.GetFieldID (class_ref, "weightChange", "D");
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, weightChange_jfieldId, value);
				} finally {
				}
			}
		}
		...
		public virtual unsafe global::Java.Lang.Object TrainingData {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return global::Java.Lang.Object.GetObject<global::Java.Lang.Object> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getTrainingData), JniHandleOwnership.TransferLocalRef);
					else
						return global::Java.Lang.Object.GetObject<global::Java.Lang.Object> (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getTrainingData", "()Ljava/lang/Object;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
			...
			set {
				...
				try {
					...
					if (GetType () == ThresholdType)
						JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setTrainingData_Ljava_lang_Object_, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setTrainingData", "(Ljava/lang/Object;)V"), __args);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		static Delegate cb_randomize_Ljava_util_Random_;
#pragma warning disable 0169
		static Delegate GetRandomize_Ljava_util_Random_Handler ()
		{
			if (cb_randomize_Ljava_util_Random_ == null)
				cb_randomize_Ljava_util_Random_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_Randomize_Ljava_util_Random_);
			return cb_randomize_Ljava_util_Random_;
		}
...
#pragma warning restore 0169
		...
		static IntPtr id_randomize_Ljava_util_Random_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core']/class[@name='Weight']/method[@name='randomize' and count(parameter)=1 and parameter[1][@type='java.util.Random']]"
		[Register ("randomize", "(Ljava/util/Random;)V", "GetRandomize_Ljava_util_Random_Handler")]
		public virtual unsafe void Randomize (global::Java.Util.Random p0)
		{
			if (id_randomize_Ljava_util_Random_ == IntPtr.Zero)
				id_randomize_Ljava_util_Random_ = JNIEnv.GetMethodID (class_ref, "randomize", "(Ljava/util/Random;)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_randomize_Ljava_util_Random_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "randomize", "(Ljava/util/Random;)V"), __args);
			} finally {
			}
		}
