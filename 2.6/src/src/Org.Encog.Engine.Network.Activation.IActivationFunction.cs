...
namespace Org.Encog.Engine.Network.Activation {
	...
	public partial interface IActivationFunction : global::Java.IO.ISerializable, global::Java.Lang.ICloneable {
		...
		bool HasDerivative {
			...
			[Register ("hasDerivative", "()Z", "GetHasDerivativeHandler:Org.Encog.Engine.Network.Activation.IActivationFunctionInvoker, Neuroph_2.6")] get;
		}
		...
		[Register ("activationFunction", "([DII)V", "GetActivationFunction_arrayDIIHandler:Org.Encog.Engine.Network.Activation.IActivationFunctionInvoker, Neuroph_2.6")]
		...
		[Register ("clone", "()Lorg/encog/engine/network/activation/ActivationFunction;", "GetCloneHandler:Org.Encog.Engine.Network.Activation.IActivationFunctionInvoker, Neuroph_2.6")]
		...
		[Register ("derivativeFunction", "(D)D", "GetDerivativeFunction_DHandler:Org.Encog.Engine.Network.Activation.IActivationFunctionInvoker, Neuroph_2.6")]
		...
		[Register ("getOpenCLExpression", "(Z)Ljava/lang/String;", "GetGetOpenCLExpression_ZHandler:Org.Encog.Engine.Network.Activation.IActivationFunctionInvoker, Neuroph_2.6")]
		...
		[Register ("getParamNames", "()[Ljava/lang/String;", "GetGetParamNamesHandler:Org.Encog.Engine.Network.Activation.IActivationFunctionInvoker, Neuroph_2.6")]
		...
		[Register ("getParams", "()[D", "GetGetParamsHandler:Org.Encog.Engine.Network.Activation.IActivationFunctionInvoker, Neuroph_2.6")]
		double[] GetParams ();
		...
		[Register ("setParam", "(ID)V", "GetSetParam_IDHandler:Org.Encog.Engine.Network.Activation.IActivationFunctionInvoker, Neuroph_2.6")]
