...
namespace Org.Neuroph.Core.Learning {
	...
	[global::Java.Interop.JavaTypeParameters (new string [] {"E extends org.neuroph.core.learning.TrainingElement"})]
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						...
						return JNIEnv.CallNonvirtualIntMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getIdealSize", "()I"));
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		static Delegate cb_setInputSize_I;
#pragma warning disable 0169
		static Delegate GetSetInputSize_IHandler ()
		{
			if (cb_setInputSize_I == null)
				cb_setInputSize_I = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, int>) n_SetInputSize_I);
			return cb_setInputSize_I;
		}

		static void n_SetInputSize_I (IntPtr jnienv, IntPtr native__this, int p0)
		{
			global::Org.Neuroph.Core.Learning.TrainingSet __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.TrainingSet> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.InputSize = p0;
		}
#pragma warning restore 0169
		...
		static IntPtr id_setInputSize_I;
		public virtual unsafe int InputSize {
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='TrainingSet']/method[@name='setInputSize' and count(parameter)=1 and parameter[1][@type='int']]"
			[Register ("setInputSize", "(I)V", "GetSetInputSize_IHandler")]
			set {
				if (id_setInputSize_I == IntPtr.Zero)
					id_setInputSize_I = JNIEnv.GetMethodID (class_ref, "setInputSize", "(I)V");
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);

					if (GetType () == ThresholdType)
						JNIEnv.CallVoidMethod  (Handle, id_setInputSize_I, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setInputSize", "(I)V"), __args);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		static Delegate cb_setOutputSize_I;
#pragma warning disable 0169
		static Delegate GetSetOutputSize_IHandler ()
		{
			if (cb_setOutputSize_I == null)
				cb_setOutputSize_I = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, int>) n_SetOutputSize_I);
			return cb_setOutputSize_I;
		}

		static void n_SetOutputSize_I (IntPtr jnienv, IntPtr native__this, int p0)
		{
			global::Org.Neuroph.Core.Learning.TrainingSet __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.TrainingSet> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.OutputSize = p0;
		}
#pragma warning restore 0169

		static IntPtr id_getOutputSize;
		static IntPtr id_setOutputSize_I;
		public virtual unsafe int OutputSize {
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='TrainingSet']/method[@name='setOutputSize' and count(parameter)=1 and parameter[1][@type='int']]"
			[Register ("setOutputSize", "(I)V", "GetSetOutputSize_IHandler")]
			set {
				if (id_setOutputSize_I == IntPtr.Zero)
					id_setOutputSize_I = JNIEnv.GetMethodID (class_ref, "setOutputSize", "(I)V");
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);

					if (GetType () == ThresholdType)
						JNIEnv.CallVoidMethod  (Handle, id_setOutputSize_I, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setOutputSize", "(I)V"), __args);
				} finally {
				}
			}
		}
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						...
						return JNIEnv.CallNonvirtualLongMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getRecordCount", "()J"));
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='TrainingSet']/method[@name='addElement' and count(parameter)=1 and parameter[1][@type='E']]"
		...
		public virtual unsafe void AddElement (global::Java.Lang.Object p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_addElement_Lorg_neuroph_core_learning_TrainingElement_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "addElement", "(Lorg/neuroph/core/learning/TrainingElement;)V"), __args);
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='TrainingSet']/method[@name='createFromFile' and count(parameter)=4 and parameter[1][@type='java.lang.String'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='java.lang.String']]"
		[Register ("createFromFile", "(Ljava/lang/String;IILjava/lang/String;)Lorg/neuroph/core/learning/TrainingSet;", "")]
		public static unsafe global::Org.Neuroph.Core.Learning.TrainingSet CreateFromFile (string p0, int p1, int p2, string p3)
		{
			if (id_createFromFile_Ljava_lang_String_IILjava_lang_String_ == IntPtr.Zero)
				id_createFromFile_Ljava_lang_String_IILjava_lang_String_ = JNIEnv.GetStaticMethodID (class_ref, "createFromFile", "(Ljava/lang/String;IILjava/lang/String;)Lorg/neuroph/core/learning/TrainingSet;");
			IntPtr native_p0 = JNIEnv.NewString (p0);
			...
			try {
				...
				global::Org.Neuroph.Core.Learning.TrainingSet __ret = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.TrainingSet> (JNIEnv.CallStaticObjectMethod  (class_ref, id_createFromFile_Ljava_lang_String_IILjava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='TrainingSet']/method[@name='createTrainingAndTestSubsets' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
		[Register ("createTrainingAndTestSubsets", "(II)[Lorg/neuroph/core/learning/TrainingSet;", "GetCreateTrainingAndTestSubsets_IIHandler")]
		public virtual unsafe global::Org.Neuroph.Core.Learning.TrainingSet[] CreateTrainingAndTestSubsets (int p0, int p1)
		{
			if (id_createTrainingAndTestSubsets_II == IntPtr.Zero)
				id_createTrainingAndTestSubsets_II = JNIEnv.GetMethodID (class_ref, "createTrainingAndTestSubsets", "(II)[Lorg/neuroph/core/learning/TrainingSet;");
			try {
				JValue* __args = stackalloc JValue [2];
				__args [0] = new JValue (p0);
				__args [1] = new JValue (p1);
				...
				if (GetType () == ThresholdType)
					return (global::Org.Neuroph.Core.Learning.TrainingSet[]) JNIEnv.GetArray (JNIEnv.CallObjectMethod  (Handle, id_createTrainingAndTestSubsets_II, __args), JniHandleOwnership.TransferLocalRef, typeof (global::Org.Neuroph.Core.Learning.TrainingSet));
				else
					return (global::Org.Neuroph.Core.Learning.TrainingSet[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "createTrainingAndTestSubsets", "(II)[Lorg/neuroph/core/learning/TrainingSet;"), __args), JniHandleOwnership.TransferLocalRef, typeof (global::Org.Neuroph.Core.Learning.TrainingSet));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Org.Neuroph.Core.Learning.TrainingElement ElementAt (int p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.TrainingElement> (JNIEnv.CallObjectMethod  (Handle, id_elementAt_I, __args), JniHandleOwnership.TransferLocalRef);
				else
					return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.TrainingElement> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "elementAt", "(I)Lorg/neuroph/core/learning/TrainingElement;"), __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}

		static Delegate cb_elements;
#pragma warning disable 0169
		static Delegate GetElementsHandler ()
		{
			if (cb_elements == null)
				cb_elements = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_Elements);
			return cb_elements;
		}

		static IntPtr n_Elements (IntPtr jnienv, IntPtr native__this)
		{
			global::Org.Neuroph.Core.Learning.TrainingSet __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.TrainingSet> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		static IntPtr id_elements;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='TrainingSet']/method[@name='elements' and count(parameter)=0]"
		[Register ("elements", "()Ljava/util/List;", "GetElementsHandler")]
		public virtual unsafe global::System.Collections.IList Elements ()
		{
			if (id_elements == IntPtr.Zero)
				id_elements = JNIEnv.GetMethodID (class_ref, "elements", "()Ljava/util/List;");
			try {

				if (GetType () == ThresholdType)
					return global::Android.Runtime.JavaList.FromJniHandle (JNIEnv.CallObjectMethod  (Handle, id_elements), JniHandleOwnership.TransferLocalRef);
				else
					return global::Android.Runtime.JavaList.FromJniHandle (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "elements", "()Ljava/util/List;")), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
		...
		public virtual unsafe void GetRecord (long p0, global::Org.Encog.Engine.Data.IEngineData p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getRecord", "(JLorg/encog/engine/data/EngineData;)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='TrainingSet']/method[@name='normalize' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='TrainingSet']/method[@name='normalize' and count(parameter)=1 and parameter[1][@type='org.neuroph.util.norm.Normalizer']]"
		...
		public virtual unsafe global::Org.Encog.Engine.Data.IEngineIndexableSet OpenAdditional ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					return global::Java.Lang.Object.GetObject<global::Org.Encog.Engine.Data.IEngineIndexableSet> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "openAdditional", "()Lorg/encog/engine/data/EngineIndexableSet;")), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void RemoveElementAt (int p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_removeElementAt_I, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "removeElementAt", "(I)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='TrainingSet']/method[@name='saveAsTxt' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='TrainingSet']/method[@name='shuffle' and count(parameter)=0]"
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Core.Learning.TrainingSet __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.TrainingSet> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return global::Android.Runtime.JavaList.ToLocalJniHandle (__this.TrainingElements ());
		}
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.IList TrainingElements ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return global::Android.Runtime.JavaList.FromJniHandle (JNIEnv.CallObjectMethod  (Handle, id_trainingElements), JniHandleOwnership.TransferLocalRef);
				else
					return global::Android.Runtime.JavaList.FromJniHandle (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "trainingElements", "()Ljava/util/List;")), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
