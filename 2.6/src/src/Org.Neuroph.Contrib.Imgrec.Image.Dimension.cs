...
namespace Org.Neuroph.Contrib.Imgrec.Image {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.contrib.imgrec.image']/class[@name='Dimension']"
	[global::Android.Runtime.Register ("org/neuroph/contrib/imgrec/image/Dimension", DoNotGenerateAcw=true)]
	public partial class Dimension : global::Java.Lang.Object, global::Java.IO.ISerializable {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/contrib/imgrec/image/Dimension", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.contrib.imgrec.image']/class[@name='Dimension']/constructor[@name='Dimension' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
		[Register (".ctor", "(II)V", "")]
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Contrib.Imgrec.Image.Dimension __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Contrib.Imgrec.Image.Dimension> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe int Height {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec.image']/class[@name='Dimension']/method[@name='getHeight' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec.image']/class[@name='Dimension']/method[@name='setHeight' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int Width {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec.image']/class[@name='Dimension']/method[@name='getWidth' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec.image']/class[@name='Dimension']/method[@name='setWidth' and count(parameter)=1 and parameter[1][@type='int']]"
