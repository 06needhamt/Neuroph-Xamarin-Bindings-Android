...
namespace Org.Neuroph.Util.IO {
	...
	public partial interface IInputAdapter : IJavaObject {
		...
		[Register ("close", "()V", "GetCloseHandler:Org.Neuroph.Util.IO.IInputAdapterInvoker, Neuroph_2.6")]
		void Close ();
		...
		[Register ("readInput", "()[D", "GetReadInputHandler:Org.Neuroph.Util.IO.IInputAdapterInvoker, Neuroph_2.6")]
		double[] ReadInput ();
