...
namespace Org.Neuroph.Contrib.Matrixmlp {
	...
	public partial interface IMatrixLayer : IJavaObject {
		...
		[Register ("calculate", "()V", "GetCalculateHandler:Org.Neuroph.Contrib.Matrixmlp.IMatrixLayerInvoker, Neuroph_2.6")]
		void Calculate ();
		...
		[Register ("getInputs", "()[D", "GetGetInputsHandler:Org.Neuroph.Contrib.Matrixmlp.IMatrixLayerInvoker, Neuroph_2.6")]
		double[] GetInputs ();
		...
		[Register ("getOutputs", "()[D", "GetGetOutputsHandler:Org.Neuroph.Contrib.Matrixmlp.IMatrixLayerInvoker, Neuroph_2.6")]
		double[] GetOutputs ();
		...
		[Register ("setInputs", "([D)V", "GetSetInputs_arrayDHandler:Org.Neuroph.Contrib.Matrixmlp.IMatrixLayerInvoker, Neuroph_2.6")]
		...
		[Register ("setOutputs", "([D)V", "GetSetOutputs_arrayDHandler:Org.Neuroph.Contrib.Matrixmlp.IMatrixLayerInvoker, Neuroph_2.6")]
