...
namespace Org.Neuroph.Contrib.Imgrec.Image {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.contrib.imgrec.image']/class[@name='ImageJ2SE']"
	[global::Android.Runtime.Register ("org/neuroph/contrib/imgrec/image/ImageJ2SE", DoNotGenerateAcw=true)]
	public partial class ImageJ2SE : global::Java.Lang.Object, global::Org.Neuroph.Contrib.Imgrec.Image.IImage {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/contrib/imgrec/image/ImageJ2SE", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ImageJ2SE); }
		}

		protected ImageJ2SE (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}
...
#pragma warning restore 0169
		...
		public virtual unsafe int Height {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec.image']/class[@name='ImageJ2SE']/method[@name='getHeight' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int Type {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec.image']/class[@name='ImageJ2SE']/method[@name='getType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int Width {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec.image']/class[@name='ImageJ2SE']/method[@name='getWidth' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec.image']/class[@name='ImageJ2SE']/method[@name='cropImage' and count(parameter)=5 and parameter[1][@type='org.neuroph.contrib.imgrec.image.Image'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int'] and parameter[5][@type='int']]"
		...
		public virtual unsafe global::Org.Neuroph.Contrib.Imgrec.Image.IImage CropImage (global::Org.Neuroph.Contrib.Imgrec.Image.IImage p0, int p1, int p2, int p3, int p4)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Contrib.Imgrec.Image.IImage> (JNIEnv.CallObjectMethod  (Handle, id_cropImage_Lorg_neuroph_contrib_imgrec_image_Image_IIII, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Contrib.Imgrec.Image.IImage> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "cropImage", "(Lorg/neuroph/contrib/imgrec/image/Image;IIII)Lorg/neuroph/contrib/imgrec/image/Image;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec.image']/class[@name='ImageJ2SE']/method[@name='getPixel' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec.image']/class[@name='ImageJ2SE']/method[@name='getPixels' and count(parameter)=6 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int'] and parameter[5][@type='int'] and parameter[6][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec.image']/class[@name='ImageJ2SE']/method[@name='resizeImage' and count(parameter)=3 and parameter[1][@type='org.neuroph.contrib.imgrec.image.Image'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
		...
		public virtual unsafe global::Org.Neuroph.Contrib.Imgrec.Image.IImage ResizeImage (global::Org.Neuroph.Contrib.Imgrec.Image.IImage p0, int p1, int p2)
		{
			...
			try {
				...
				global::Org.Neuroph.Contrib.Imgrec.Image.IImage __ret;
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Contrib.Imgrec.Image.IImage> (JNIEnv.CallObjectMethod  (Handle, id_resizeImage_Lorg_neuroph_contrib_imgrec_image_Image_II, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Contrib.Imgrec.Image.IImage> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "resizeImage", "(Lorg/neuroph/contrib/imgrec/image/Image;II)Lorg/neuroph/contrib/imgrec/image/Image;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec.image']/class[@name='ImageJ2SE']/method[@name='setPixel' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec.image']/class[@name='ImageJ2SE']/method[@name='setPixels' and count(parameter)=7 and parameter[1][@type='int[]'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int'] and parameter[5][@type='int'] and parameter[6][@type='int'] and parameter[7][@type='int']]"
