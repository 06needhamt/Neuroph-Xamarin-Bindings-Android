...
namespace Org.Neuroph.Contrib.Imgrec {
	...
	public partial class ImageRecognitionPlugin : global::Org.Neuroph.Util.Plugins.PluginBase, global::Java.IO.ISerializable {
		...
		static IntPtr id_ctor_Lorg_neuroph_contrib_imgrec_image_Dimension_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.contrib.imgrec']/class[@name='ImageRecognitionPlugin']/constructor[@name='ImageRecognitionPlugin' and count(parameter)=1 and parameter[1][@type='org.neuroph.contrib.imgrec.image.Dimension']]"
		[Register (".ctor", "(Lorg/neuroph/contrib/imgrec/image/Dimension;)V", "")]
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (id_ctor_Lorg_neuroph_contrib_imgrec_image_Dimension_ == IntPtr.Zero)
					id_ctor_Lorg_neuroph_contrib_imgrec_image_Dimension_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lorg/neuroph/contrib/imgrec/image/Dimension;)V");
				SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.contrib.imgrec']/class[@name='ImageRecognitionPlugin']/constructor[@name='ImageRecognitionPlugin' and count(parameter)=2 and parameter[1][@type='org.neuroph.contrib.imgrec.image.Dimension'] and parameter[2][@type='org.neuroph.contrib.imgrec.ColorMode']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Org.Neuroph.Contrib.Imgrec.Image.Dimension SamplingResolution {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec']/class[@name='ImageRecognitionPlugin']/method[@name='getSamplingResolution' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		static Delegate cb_recognizeImage_Lorg_neuroph_contrib_imgrec_image_Image_;
#pragma warning disable 0169
		static Delegate GetRecognizeImage_Lorg_neuroph_contrib_imgrec_image_Image_Handler ()
		{
			if (cb_recognizeImage_Lorg_neuroph_contrib_imgrec_image_Image_ == null)
				cb_recognizeImage_Lorg_neuroph_contrib_imgrec_image_Image_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr>) n_RecognizeImage_Lorg_neuroph_contrib_imgrec_image_Image_);
			return cb_recognizeImage_Lorg_neuroph_contrib_imgrec_image_Image_;
		}
...
#pragma warning restore 0169
		...
		static IntPtr id_recognizeImage_Lorg_neuroph_contrib_imgrec_image_Image_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec']/class[@name='ImageRecognitionPlugin']/method[@name='recognizeImage' and count(parameter)=1 and parameter[1][@type='org.neuroph.contrib.imgrec.image.Image']]"
		[Register ("recognizeImage", "(Lorg/neuroph/contrib/imgrec/image/Image;)Ljava/util/HashMap;", "GetRecognizeImage_Lorg_neuroph_contrib_imgrec_image_Image_Handler")]
...
#pragma warning restore 0169
		...
		static Delegate cb_setInput_Lorg_neuroph_contrib_imgrec_image_Image_;
#pragma warning disable 0169
		static Delegate GetSetInput_Lorg_neuroph_contrib_imgrec_image_Image_Handler ()
		{
			if (cb_setInput_Lorg_neuroph_contrib_imgrec_image_Image_ == null)
				cb_setInput_Lorg_neuroph_contrib_imgrec_image_Image_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_SetInput_Lorg_neuroph_contrib_imgrec_image_Image_);
			return cb_setInput_Lorg_neuroph_contrib_imgrec_image_Image_;
		}
...
#pragma warning restore 0169
		...
		static IntPtr id_setInput_Lorg_neuroph_contrib_imgrec_image_Image_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec']/class[@name='ImageRecognitionPlugin']/method[@name='setInput' and count(parameter)=1 and parameter[1][@type='org.neuroph.contrib.imgrec.image.Image']]"
		[Register ("setInput", "(Lorg/neuroph/contrib/imgrec/image/Image;)V", "GetSetInput_Lorg_neuroph_contrib_imgrec_image_Image_Handler")]
