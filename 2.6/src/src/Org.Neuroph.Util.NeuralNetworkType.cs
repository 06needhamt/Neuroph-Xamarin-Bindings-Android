...
namespace Org.Neuroph.Util {
	...
	public sealed partial class NeuralNetworkType : global::Java.Lang.Enum {
		...
		static IntPtr BOLTZMAN_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='org.neuroph.util']/class[@name='NeuralNetworkType']/field[@name='BOLTZMAN']"
		[Register ("BOLTZMAN")]
		public static global::Org.Neuroph.Util.NeuralNetworkType Boltzman {
			get {
				if (BOLTZMAN_jfieldId == IntPtr.Zero)
					BOLTZMAN_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "BOLTZMAN", "Lorg/neuroph/util/NeuralNetworkType;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, BOLTZMAN_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Util.NeuralNetworkType> (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}
		...
		static IntPtr COUNTERPROPAGATION_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='org.neuroph.util']/class[@name='NeuralNetworkType']/field[@name='COUNTERPROPAGATION']"
		[Register ("COUNTERPROPAGATION")]
		public static global::Org.Neuroph.Util.NeuralNetworkType Counterpropagation {
			get {
				if (COUNTERPROPAGATION_jfieldId == IntPtr.Zero)
					COUNTERPROPAGATION_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "COUNTERPROPAGATION", "Lorg/neuroph/util/NeuralNetworkType;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, COUNTERPROPAGATION_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Util.NeuralNetworkType> (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}
		...
		static IntPtr INSTAR_OUTSTAR_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='org.neuroph.util']/class[@name='NeuralNetworkType']/field[@name='INSTAR_OUTSTAR']"
		[Register ("INSTAR_OUTSTAR")]
		public static global::Org.Neuroph.Util.NeuralNetworkType InstarOutstar {
			get {
				if (INSTAR_OUTSTAR_jfieldId == IntPtr.Zero)
					INSTAR_OUTSTAR_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "INSTAR_OUTSTAR", "Lorg/neuroph/util/NeuralNetworkType;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, INSTAR_OUTSTAR_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Util.NeuralNetworkType> (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}
		...
		static IntPtr PCA_NETWORK_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='org.neuroph.util']/class[@name='NeuralNetworkType']/field[@name='PCA_NETWORK']"
		[Register ("PCA_NETWORK")]
		public static global::Org.Neuroph.Util.NeuralNetworkType PcaNetwork {
			get {
				if (PCA_NETWORK_jfieldId == IntPtr.Zero)
					PCA_NETWORK_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "PCA_NETWORK", "Lorg/neuroph/util/NeuralNetworkType;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, PCA_NETWORK_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Util.NeuralNetworkType> (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}
