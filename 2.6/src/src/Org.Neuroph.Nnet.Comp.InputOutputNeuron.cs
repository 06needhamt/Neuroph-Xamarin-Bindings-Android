...
namespace Org.Neuroph.Nnet.Comp {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.nnet.comp']/class[@name='InputOutputNeuron']"
	[global::Android.Runtime.Register ("org/neuroph/nnet/comp/InputOutputNeuron", DoNotGenerateAcw=true)]
	public partial class InputOutputNeuron : global::Org.Neuroph.Core.Neuron {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/nnet/comp/InputOutputNeuron", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.nnet.comp']/class[@name='InputOutputNeuron']/constructor[@name='InputOutputNeuron' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.nnet.comp']/class[@name='InputOutputNeuron']/constructor[@name='InputOutputNeuron' and count(parameter)=2 and parameter[1][@type='org.neuroph.core.input.InputFunction'] and parameter[2][@type='org.neuroph.core.transfer.TransferFunction']]"
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Nnet.Comp.InputOutputNeuron __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Nnet.Comp.InputOutputNeuron> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.Bias;
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe double Bias {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.nnet.comp']/class[@name='InputOutputNeuron']/method[@name='getBias' and count(parameter)=0]"
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return JNIEnv.CallDoubleMethod (((global::Java.Lang.Object) this).Handle, id_getBias);
					else
						return JNIEnv.CallNonvirtualDoubleMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getBias", "()D"));
				} finally {
				}
			}
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.nnet.comp']/class[@name='InputOutputNeuron']/method[@name='setBias' and count(parameter)=1 and parameter[1][@type='double']]"
			...
			set {
				...
				try {
					...
					if (GetType () == ThresholdType)
						JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setBias_D, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setBias", "(D)V"), __args);
				} finally {
				}
			}
		}
