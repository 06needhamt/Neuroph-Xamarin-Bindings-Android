...
namespace Org.Neuroph.Samples {
	...
	public partial class IrisClassificationSample : global::Java.Lang.Object {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples']/class[@name='IrisClassificationSample']/method[@name='testNeuralNetwork' and count(parameter)=2 and parameter[1][@type='org.neuroph.core.NeuralNetwork'] and parameter[2][@type='org.neuroph.core.learning.TrainingSet&lt;org.neuroph.core.learning.SupervisedTrainingElement&gt;']]"
