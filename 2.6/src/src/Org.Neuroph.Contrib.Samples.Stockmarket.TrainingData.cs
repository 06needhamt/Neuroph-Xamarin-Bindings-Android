...
namespace Org.Neuroph.Contrib.Samples.Stockmarket {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.contrib.samples.stockmarket']/class[@name='TrainingData']"
	[global::Android.Runtime.Register ("org/neuroph/contrib/samples/stockmarket/TrainingData", DoNotGenerateAcw=true)]
	public partial class TrainingData : global::Java.Lang.Object {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/contrib/samples/stockmarket/TrainingData", ref java_class_handle);
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe double Normalizer {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.samples.stockmarket']/class[@name='TrainingData']/method[@name='getNormalizer' and count(parameter)=0]"
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return JNIEnv.CallDoubleMethod  (Handle, id_getNormalizer);
					else
						return JNIEnv.CallNonvirtualDoubleMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getNormalizer", "()D"));
				} finally {
				}
			}
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.samples.stockmarket']/class[@name='TrainingData']/method[@name='setNormalizer' and count(parameter)=1 and parameter[1][@type='double']]"
			...
			set {
				...
				try {
					...
					if (GetType () == ThresholdType)
						JNIEnv.CallVoidMethod  (Handle, id_setNormalizer_D, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setNormalizer", "(D)V"), __args);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Org.Neuroph.Core.Learning.TrainingSet TrainingSet {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.samples.stockmarket']/class[@name='TrainingData']/method[@name='getTrainingSet' and count(parameter)=0]"
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.TrainingSet> (JNIEnv.CallObjectMethod  (Handle, id_getTrainingSet), JniHandleOwnership.TransferLocalRef);
					else
						return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.TrainingSet> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getTrainingSet", "()Lorg/neuroph/core/learning/TrainingSet;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.samples.stockmarket']/class[@name='TrainingData']/method[@name='setTrainingSet' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.learning.TrainingSet']]"
			...
			set {
				...
				try {
					...
					if (GetType () == ThresholdType)
						JNIEnv.CallVoidMethod  (Handle, id_setTrainingSet_Lorg_neuroph_core_learning_TrainingSet_, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setTrainingSet", "(Lorg/neuroph/core/learning/TrainingSet;)V"), __args);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.samples.stockmarket']/class[@name='TrainingData']/method[@name='getValuesRow' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.samples.stockmarket']/class[@name='TrainingData']/method[@name='setValuesRow' and count(parameter)=1 and parameter[1][@type='java.lang.String[]']]"
