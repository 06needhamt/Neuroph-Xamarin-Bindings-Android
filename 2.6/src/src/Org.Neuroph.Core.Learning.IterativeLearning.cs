	...
	public abstract partial class IterativeLearning : global::Org.Neuroph.Core.Learning.LearningRule, global::Java.IO.ISerializable {
		...
		protected bool IterationsLimited {
			get {
				...
				return JNIEnv.GetBooleanField (((global::Java.Lang.Object) this).Handle, iterationsLimited_jfieldId);
			}
			set {
				if (iterationsLimited_jfieldId == IntPtr.Zero)
					iterationsLimited_jfieldId = JNIEnv.GetFieldID (class_ref, "iterationsLimited", "Z");
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, iterationsLimited_jfieldId, value);
				} finally {
				}
			}
		}
		...
		protected int MaxIterations {
			get {
				...
				return JNIEnv.GetIntField (((global::Java.Lang.Object) this).Handle, maxIterations_jfieldId);
			}
			set {
				if (maxIterations_jfieldId == IntPtr.Zero)
					maxIterations_jfieldId = JNIEnv.GetFieldID (class_ref, "maxIterations", "I");
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, maxIterations_jfieldId, value);
				} finally {
				}
			}
		}
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return global::Java.Lang.Object.GetObject<global::Java.Lang.Integer> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getCurrentIteration), JniHandleOwnership.TransferLocalRef);
					else
						return global::Java.Lang.Object.GetObject<global::Java.Lang.Integer> (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getCurrentIteration", "()Ljava/lang/Integer;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
		...
		public virtual unsafe bool IsPausedLearning {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_isPausedLearning);
					else
						return JNIEnv.CallNonvirtualBooleanMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "isPausedLearning", "()Z"));
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		static Delegate cb_afterEpochEnd;
#pragma warning disable 0169
		static Delegate GetAfterEpochEndHandler ()
		{
			if (cb_afterEpochEnd == null)
				cb_afterEpochEnd = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr>) n_AfterEpochEnd);
			return cb_afterEpochEnd;
		}

		static void n_AfterEpochEnd (IntPtr jnienv, IntPtr native__this)
		{
			global::Org.Neuroph.Core.Learning.IterativeLearning __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.IterativeLearning> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.AfterEpochEnd ();
		}
#pragma warning restore 0169

		static IntPtr id_afterEpochEnd;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='IterativeLearning']/method[@name='afterEpochEnd' and count(parameter)=0]"
		[Register ("afterEpochEnd", "()V", "GetAfterEpochEndHandler")]
		protected virtual unsafe void AfterEpochEnd ()
		{
			if (id_afterEpochEnd == IntPtr.Zero)
				id_afterEpochEnd = JNIEnv.GetMethodID (class_ref, "afterEpochEnd", "()V");
			try {

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_afterEpochEnd);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "afterEpochEnd", "()V"));
			} finally {
			}
		}

		static Delegate cb_beforeEpochStart;
#pragma warning disable 0169
		static Delegate GetBeforeEpochStartHandler ()
		{
			if (cb_beforeEpochStart == null)
				cb_beforeEpochStart = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr>) n_BeforeEpochStart);
			return cb_beforeEpochStart;
		}

		static void n_BeforeEpochStart (IntPtr jnienv, IntPtr native__this)
		{
			global::Org.Neuroph.Core.Learning.IterativeLearning __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.IterativeLearning> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.BeforeEpochStart ();
		}
#pragma warning restore 0169

		static IntPtr id_beforeEpochStart;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='IterativeLearning']/method[@name='beforeEpochStart' and count(parameter)=0]"
		[Register ("beforeEpochStart", "()V", "GetBeforeEpochStartHandler")]
		protected virtual unsafe void BeforeEpochStart ()
		{
			if (id_beforeEpochStart == IntPtr.Zero)
				id_beforeEpochStart = JNIEnv.GetMethodID (class_ref, "beforeEpochStart", "()V");
			try {

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_beforeEpochStart);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "beforeEpochStart", "()V"));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='IterativeLearning']/method[@name='doLearningEpoch' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.learning.TrainingSet']]"
		...
		static Delegate cb_doOneLearningIteration_Lorg_neuroph_core_learning_TrainingSet_;
#pragma warning disable 0169
		static Delegate GetDoOneLearningIteration_Lorg_neuroph_core_learning_TrainingSet_Handler ()
		{
			if (cb_doOneLearningIteration_Lorg_neuroph_core_learning_TrainingSet_ == null)
				cb_doOneLearningIteration_Lorg_neuroph_core_learning_TrainingSet_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_DoOneLearningIteration_Lorg_neuroph_core_learning_TrainingSet_);
			return cb_doOneLearningIteration_Lorg_neuroph_core_learning_TrainingSet_;
		}

		static void n_DoOneLearningIteration_Lorg_neuroph_core_learning_TrainingSet_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Org.Neuroph.Core.Learning.IterativeLearning __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.IterativeLearning> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Org.Neuroph.Core.Learning.TrainingSet p0 = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.TrainingSet> (native_p0, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		static IntPtr id_doOneLearningIteration_Lorg_neuroph_core_learning_TrainingSet_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='IterativeLearning']/method[@name='doOneLearningIteration' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.learning.TrainingSet']]"
		[Register ("doOneLearningIteration", "(Lorg/neuroph/core/learning/TrainingSet;)V", "GetDoOneLearningIteration_Lorg_neuroph_core_learning_TrainingSet_Handler")]
		public virtual unsafe void DoOneLearningIteration (global::Org.Neuroph.Core.Learning.TrainingSet p0)
		{
			if (id_doOneLearningIteration_Lorg_neuroph_core_learning_TrainingSet_ == IntPtr.Zero)
				id_doOneLearningIteration_Lorg_neuroph_core_learning_TrainingSet_ = JNIEnv.GetMethodID (class_ref, "doOneLearningIteration", "(Lorg/neuroph/core/learning/TrainingSet;)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_doOneLearningIteration_Lorg_neuroph_core_learning_TrainingSet_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "doOneLearningIteration", "(Lorg/neuroph/core/learning/TrainingSet;)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='IterativeLearning']/method[@name='learn' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.learning.TrainingSet']]"
		...
		static Delegate cb_learn_Lorg_neuroph_core_learning_TrainingSet_I;
#pragma warning disable 0169
		static Delegate GetLearn_Lorg_neuroph_core_learning_TrainingSet_IHandler ()
		{
			if (cb_learn_Lorg_neuroph_core_learning_TrainingSet_I == null)
				cb_learn_Lorg_neuroph_core_learning_TrainingSet_I = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr, int>) n_Learn_Lorg_neuroph_core_learning_TrainingSet_I);
			return cb_learn_Lorg_neuroph_core_learning_TrainingSet_I;
		}
...
#pragma warning restore 0169
		...
		static IntPtr id_learn_Lorg_neuroph_core_learning_TrainingSet_I;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='IterativeLearning']/method[@name='learn' and count(parameter)=2 and parameter[1][@type='org.neuroph.core.learning.TrainingSet'] and parameter[2][@type='int']]"
		[Register ("learn", "(Lorg/neuroph/core/learning/TrainingSet;I)V", "GetLearn_Lorg_neuroph_core_learning_TrainingSet_IHandler")]
		public virtual unsafe void Learn (global::Org.Neuroph.Core.Learning.TrainingSet p0, int p1)
		{
			if (id_learn_Lorg_neuroph_core_learning_TrainingSet_I == IntPtr.Zero)
				id_learn_Lorg_neuroph_core_learning_TrainingSet_I = JNIEnv.GetMethodID (class_ref, "learn", "(Lorg/neuroph/core/learning/TrainingSet;I)V");
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_learn_Lorg_neuroph_core_learning_TrainingSet_I, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "learn", "(Lorg/neuroph/core/learning/TrainingSet;I)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='IterativeLearning']/method[@name='onStart' and count(parameter)=0]"
