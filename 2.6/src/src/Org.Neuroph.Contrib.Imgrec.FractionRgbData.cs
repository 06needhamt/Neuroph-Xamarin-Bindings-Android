...
#pragma warning restore 0169
		...
		protected virtual unsafe void PopulateRGBArrays (global::Org.Neuroph.Contrib.Imgrec.Image.IImage p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_populateRGBArrays_Lorg_neuroph_contrib_imgrec_image_Image_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "populateRGBArrays", "(Lorg/neuroph/contrib/imgrec/image/Image;)V"), __args);
			} finally {
			}
		}
