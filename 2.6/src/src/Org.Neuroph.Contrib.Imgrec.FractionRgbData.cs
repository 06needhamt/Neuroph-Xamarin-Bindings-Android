...
namespace Org.Neuroph.Contrib.Imgrec {
	...
	public partial class FractionRgbData : global::Java.Lang.Object {
		...
		static IntPtr id_ctor_Lorg_neuroph_contrib_imgrec_image_Image_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.contrib.imgrec']/class[@name='FractionRgbData']/constructor[@name='FractionRgbData' and count(parameter)=1 and parameter[1][@type='org.neuroph.contrib.imgrec.image.Image']]"
		[Register (".ctor", "(Lorg/neuroph/contrib/imgrec/image/Image;)V", "")]
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (FractionRgbData)) {
					...
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Lorg/neuroph/contrib/imgrec/image/Image;)V", __args);
					return;
				}
				...
				SetHandle (
						...
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lorg_neuroph_contrib_imgrec_image_Image_, __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		static Delegate cb_populateRGBArrays_Lorg_neuroph_contrib_imgrec_image_Image_;
#pragma warning disable 0169
		static Delegate GetPopulateRGBArrays_Lorg_neuroph_contrib_imgrec_image_Image_Handler ()
		{
			if (cb_populateRGBArrays_Lorg_neuroph_contrib_imgrec_image_Image_ == null)
				cb_populateRGBArrays_Lorg_neuroph_contrib_imgrec_image_Image_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_PopulateRGBArrays_Lorg_neuroph_contrib_imgrec_image_Image_);
			return cb_populateRGBArrays_Lorg_neuroph_contrib_imgrec_image_Image_;
		}
...
#pragma warning restore 0169
		...
		static IntPtr id_populateRGBArrays_Lorg_neuroph_contrib_imgrec_image_Image_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec']/class[@name='FractionRgbData']/method[@name='populateRGBArrays' and count(parameter)=1 and parameter[1][@type='org.neuroph.contrib.imgrec.image.Image']]"
		[Register ("populateRGBArrays", "(Lorg/neuroph/contrib/imgrec/image/Image;)V", "GetPopulateRGBArrays_Lorg_neuroph_contrib_imgrec_image_Image_Handler")]
		protected virtual unsafe void PopulateRGBArrays (global::Org.Neuroph.Contrib.Imgrec.Image.IImage p0)
		{
			if (id_populateRGBArrays_Lorg_neuroph_contrib_imgrec_image_Image_ == IntPtr.Zero)
				id_populateRGBArrays_Lorg_neuroph_contrib_imgrec_image_Image_ = JNIEnv.GetMethodID (class_ref, "populateRGBArrays", "(Lorg/neuroph/contrib/imgrec/image/Image;)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_populateRGBArrays_Lorg_neuroph_contrib_imgrec_image_Image_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "populateRGBArrays", "(Lorg/neuroph/contrib/imgrec/image/Image;)V"), __args);
			} finally {
			}
		}
