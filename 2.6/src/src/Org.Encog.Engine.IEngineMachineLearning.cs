...
namespace Org.Encog.Engine {
	...
	public partial interface IEngineMachineLearning : IJavaObject {
		...
		int InputCount {
			...
			[Register ("getInputCount", "()I", "GetGetInputCountHandler:Org.Encog.Engine.IEngineMachineLearningInvoker, Neuroph_2.6")] get;
		}
		...
		int OutputCount {
			...
			[Register ("getOutputCount", "()I", "GetGetOutputCountHandler:Org.Encog.Engine.IEngineMachineLearningInvoker, Neuroph_2.6")] get;
		}
		...
		[Register ("compute", "([D[D)V", "GetCompute_arrayDarrayDHandler:Org.Encog.Engine.IEngineMachineLearningInvoker, Neuroph_2.6")]
