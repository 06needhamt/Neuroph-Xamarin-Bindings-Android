...
#pragma warning restore 0169
		...
		public virtual unsafe void Learn (global::Org.Neuroph.Core.Learning.TrainingSet p0, global::Org.Neuroph.Core.Learning.LearningRule p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_learn_Lorg_neuroph_core_learning_TrainingSet_Lorg_neuroph_core_learning_LearningRule_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "learn", "(Lorg/neuroph/core/learning/TrainingSet;Lorg/neuroph/core/learning/LearningRule;)V"), __args);
			} finally {
			}
		}
