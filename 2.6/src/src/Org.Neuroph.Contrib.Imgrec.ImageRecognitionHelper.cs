...
namespace Org.Neuroph.Contrib.Imgrec {
	...
	public partial class ImageRecognitionHelper : global::Java.Lang.Object {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.contrib.imgrec']/class[@name='ImageRecognitionHelper']/method[@name='createNewNeuralNetwork' and count(parameter)=6 and parameter[1][@type='java.lang.String'] and parameter[2][@type='org.neuroph.contrib.imgrec.image.Dimension'] and parameter[3][@type='org.neuroph.contrib.imgrec.ColorMode'] and parameter[4][@type='java.util.List&lt;java.lang.String&gt;'] and parameter[5][@type='java.util.List&lt;java.lang.Integer&gt;'] and parameter[6][@type='org.neuroph.util.TransferFunctionType']]"
