...
namespace Org.Neuroph.Util.Norm {
	...
	public partial interface INormalizer : IJavaObject {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.util.norm']/interface[@name='Normalizer']/method[@name='normalize' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.learning.DataSet']]"
		[Register ("normalize", "(Lorg/neuroph/core/learning/DataSet;)V", "GetNormalize_Lorg_neuroph_core_learning_DataSet_Handler:Org.Neuroph.Util.Norm.INormalizerInvoker, neuroph_2.7")]
		void Normalize (global::Org.Neuroph.Core.Learning.DataSet p0);
...
#pragma warning restore 0169
		...
		IntPtr id_normalize_Lorg_neuroph_core_learning_DataSet_;
