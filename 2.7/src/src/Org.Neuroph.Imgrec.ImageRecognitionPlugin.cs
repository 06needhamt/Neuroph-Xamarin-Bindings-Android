...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.Generic.IDictionary<string, global::Java.Lang.Double> RecognizeImage (global::Org.Neuroph.Imgrec.Image.IImage p0)
		{
			...
			try {
				...
				global::System.Collections.Generic.IDictionary<string, global::Java.Lang.Double> __ret;
				if (GetType () == ThresholdType)
					__ret = global::Android.Runtime.JavaDictionary<string, global::Java.Lang.Double>.FromJniHandle (JNIEnv.CallObjectMethod  (Handle, id_recognizeImage_Lorg_neuroph_imgrec_image_Image_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Android.Runtime.JavaDictionary<string, global::Java.Lang.Double>.FromJniHandle (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "recognizeImage", "(Lorg/neuroph/imgrec/image/Image;)Ljava/util/HashMap;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void SetInput (global::Org.Neuroph.Imgrec.Image.IImage p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setInput_Lorg_neuroph_imgrec_image_Image_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setInput", "(Lorg/neuroph/imgrec/image/Image;)V"), __args);
			} finally {
			}
		}
