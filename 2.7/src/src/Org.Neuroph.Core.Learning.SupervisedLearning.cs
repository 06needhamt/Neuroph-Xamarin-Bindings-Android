		...
		public override unsafe void DoLearningEpoch (global::Org.Neuroph.Core.Learning.DataSet p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "doLearningEpoch", "(Lorg/neuroph/core/learning/DataSet;)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void Learn (global::Org.Neuroph.Core.Learning.DataSet p0, double p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_learn_Lorg_neuroph_core_learning_DataSet_D, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "learn", "(Lorg/neuroph/core/learning/DataSet;D)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void Learn (global::Org.Neuroph.Core.Learning.DataSet p0, double p1, int p2)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_learn_Lorg_neuroph_core_learning_DataSet_DI, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "learn", "(Lorg/neuroph/core/learning/DataSet;DI)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		protected virtual unsafe void LearnPattern (global::Org.Neuroph.Core.Learning.DataSetRow p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_learnPattern_Lorg_neuroph_core_learning_DataSetRow_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "learnPattern", "(Lorg/neuroph/core/learning/DataSetRow;)V"), __args);
			} finally {
			}
		}
