...
namespace Org.Neuroph.Imgrec {
	...
	public partial class ImageRecognitionHelper : global::Java.Lang.Object {
		...
		[Register ("createBlackAndWhiteTrainingSet", "(Ljava/util/List;Ljava/util/Map;)Lorg/neuroph/core/learning/DataSet;", "")]
		...
		[Register ("createTrainingSet", "(Ljava/util/List;Ljava/util/Map;)Lorg/neuroph/core/learning/DataSet;", "")]
		public static unsafe global::Org.Neuroph.Core.Learning.DataSet CreateTrainingSet (global::System.Collections.Generic.IList<string> p0, global::System.Collections.Generic.IDictionary<string, global::Org.Neuroph.Imgrec.FractionRgbData> p1)
		{
			if (id_createTrainingSet_Ljava_util_List_Ljava_util_Map_ == IntPtr.Zero)
				id_createTrainingSet_Ljava_util_List_Ljava_util_Map_ = JNIEnv.GetStaticMethodID (class_ref, "createTrainingSet", "(Ljava/util/List;Ljava/util/Map;)Lorg/neuroph/core/learning/DataSet;");
			IntPtr native_p0 = global::Android.Runtime.JavaList<string>.ToLocalJniHandle (p0);
			IntPtr native_p1 = global::Android.Runtime.JavaDictionary<string, global::Org.Neuroph.Imgrec.FractionRgbData>.ToLocalJniHandle (p1);
			try {
				JValue* __args = stackalloc JValue [2];
				__args [0] = new JValue (native_p0);
				__args [1] = new JValue (native_p1);
				global::Org.Neuroph.Core.Learning.DataSet __ret = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.DataSet> (JNIEnv.CallStaticObjectMethod  (class_ref, id_createTrainingSet_Ljava_util_List_Ljava_util_Map_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
				JNIEnv.DeleteLocalRef (native_p1);
