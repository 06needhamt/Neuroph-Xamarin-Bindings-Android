...
namespace Org.Neuroph.Imgrec.Image {
	...
	public partial interface IImage : IJavaObject {
		...
		int Height {
			...
			[Register ("getHeight", "()I", "GetGetHeightHandler:Org.Neuroph.Imgrec.Image.IImageInvoker, neuroph_2.7")] get;
		}
		...
		int Type {
			...
			[Register ("getType", "()I", "GetGetTypeHandler:Org.Neuroph.Imgrec.Image.IImageInvoker, neuroph_2.7")] get;
		}
		...
		int Width {
			...
			[Register ("getWidth", "()I", "GetGetWidthHandler:Org.Neuroph.Imgrec.Image.IImageInvoker, neuroph_2.7")] get;
		}
		...
		[Register ("crop", "(IIII)Lorg/neuroph/imgrec/image/Image;", "GetCrop_IIIIHandler:Org.Neuroph.Imgrec.Image.IImageInvoker, neuroph_2.7")]
		...
		[Register ("getPixel", "(II)I", "GetGetPixel_IIHandler:Org.Neuroph.Imgrec.Image.IImageInvoker, neuroph_2.7")]
		...
		[Register ("getPixels", "(IIIIII)[I", "GetGetPixels_IIIIIIHandler:Org.Neuroph.Imgrec.Image.IImageInvoker, neuroph_2.7")]
		...
		[Register ("resize", "(II)Lorg/neuroph/imgrec/image/Image;", "GetResize_IIHandler:Org.Neuroph.Imgrec.Image.IImageInvoker, neuroph_2.7")]
		...
		[Register ("setPixel", "(III)V", "GetSetPixel_IIIHandler:Org.Neuroph.Imgrec.Image.IImageInvoker, neuroph_2.7")]
		...
		[Register ("setPixels", "([IIIIIII)V", "GetSetPixels_arrayIIIIIIIHandler:Org.Neuroph.Imgrec.Image.IImageInvoker, neuroph_2.7")]
