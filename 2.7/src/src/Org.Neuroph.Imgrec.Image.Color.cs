...
namespace Org.Neuroph.Imgrec.Image {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.imgrec.image']/class[@name='Color']"
	[global::Android.Runtime.Register ("org/neuroph/imgrec/image/Color", DoNotGenerateAcw=true)]
	public partial class Color : global::Java.Lang.Object {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/imgrec/image/Color", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.imgrec.image']/class[@name='Color']/constructor[@name='Color' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register (".ctor", "(I)V", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.imgrec.image']/class[@name='Color']/method[@name='getBlue' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Imgrec.Image.Color __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Imgrec.Image.Color> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.GetColor ();
		}
#pragma warning restore 0169

		static IntPtr id_getColor;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.imgrec.image']/class[@name='Color']/method[@name='getColor' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.imgrec.image']/class[@name='Color']/method[@name='getGreen' and count(parameter)=1 and parameter[1][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.imgrec.image']/class[@name='Color']/method[@name='getRed' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("getRed", "(I)I", "")]
