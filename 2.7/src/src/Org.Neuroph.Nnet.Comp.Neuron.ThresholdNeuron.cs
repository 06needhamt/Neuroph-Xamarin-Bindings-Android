...
namespace Org.Neuroph.Nnet.Comp.Neuron {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.nnet.comp.neuron']/class[@name='ThresholdNeuron']"
	[global::Android.Runtime.Register ("org/neuroph/nnet/comp/neuron/ThresholdNeuron", DoNotGenerateAcw=true)]
	public partial class ThresholdNeuron : global::Org.Neuroph.Core.Neuron {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/nnet/comp/neuron/ThresholdNeuron", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.nnet.comp.neuron']/class[@name='ThresholdNeuron']/constructor[@name='ThresholdNeuron' and count(parameter)=2 and parameter[1][@type='org.neuroph.core.input.InputFunction'] and parameter[2][@type='org.neuroph.core.transfer.TransferFunction']]"
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Nnet.Comp.Neuron.ThresholdNeuron __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Nnet.Comp.Neuron.ThresholdNeuron> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe double Thresh {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.nnet.comp.neuron']/class[@name='ThresholdNeuron']/method[@name='getThresh' and count(parameter)=0]"
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return JNIEnv.CallDoubleMethod  (Handle, id_getThresh);
					else
						return JNIEnv.CallNonvirtualDoubleMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getThresh", "()D"));
				} finally {
				}
			}
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.nnet.comp.neuron']/class[@name='ThresholdNeuron']/method[@name='setThresh' and count(parameter)=1 and parameter[1][@type='double']]"
			...
			set {
				...
				try {
					...
					if (GetType () == ThresholdType)
						JNIEnv.CallVoidMethod  (Handle, id_setThresh_D, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setThresh", "(D)V"), __args);
				} finally {
				}
			}
		}
