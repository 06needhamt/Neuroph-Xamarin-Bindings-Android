...
namespace Org.Neuroph.Core.Learning {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']"
	[global::Android.Runtime.Register ("org/neuroph/core/learning/DataSet", DoNotGenerateAcw=true)]
	public partial class DataSet : global::Java.Lang.Object, global::Java.IO.ISerializable {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/core/learning/DataSet", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/constructor[@name='DataSet' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register (".ctor", "(I)V", "")]
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/constructor[@name='DataSet' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
		[Register (".ctor", "(II)V", "")]
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Core.Learning.DataSet __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.DataSet> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string FilePath {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='getFilePath' and count(parameter)=0]"
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return JNIEnv.GetString (JNIEnv.CallObjectMethod  (Handle, id_getFilePath), JniHandleOwnership.TransferLocalRef);
					else
						return JNIEnv.GetString (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getFilePath", "()Ljava/lang/String;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='setFilePath' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int InputSize {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='getInputSize' and count(parameter)=0]"
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						...
						return JNIEnv.CallNonvirtualIntMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getInputSize", "()I"));
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsEmpty {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='isEmpty' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsSupervised {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='isSupervised' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Label {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='getLabel' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='setLabel' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int OutputSize {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='getOutputSize' and count(parameter)=0]"
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return JNIEnv.CallIntMethod  (Handle, id_getOutputSize);
					else
						return JNIEnv.CallNonvirtualIntMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getOutputSize", "()I"));
				} finally {
				}
			}
		}
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Core.Learning.DataSet __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.DataSet> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return global::Android.Runtime.JavaList<global::Org.Neuroph.Core.Learning.DataSetRow>.ToLocalJniHandle (__this.Rows);
		}
#pragma warning restore 0169

		static IntPtr id_getRows;
		public virtual unsafe global::System.Collections.Generic.IList<global::Org.Neuroph.Core.Learning.DataSetRow> Rows {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='getRows' and count(parameter)=0]"
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return global::Android.Runtime.JavaList<global::Org.Neuroph.Core.Learning.DataSetRow>.FromJniHandle (JNIEnv.CallObjectMethod  (Handle, id_getRows), JniHandleOwnership.TransferLocalRef);
					else
						return global::Android.Runtime.JavaList<global::Org.Neuroph.Core.Learning.DataSetRow>.FromJniHandle (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getRows", "()Ljava/util/List;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='addRow' and count(parameter)=1 and parameter[1][@type='double[]']]"
		...
		public virtual unsafe void AddRow (double[] p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_addRow_arrayD, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "addRow", "([D)V"), __args);
			} finally {
				if (p0 != null) {
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='addRow' and count(parameter)=2 and parameter[1][@type='double[]'] and parameter[2][@type='double[]']]"
		...
		public virtual unsafe void AddRow (double[] p0, double[] p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_addRow_arrayDarrayD, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "addRow", "([D[D)V"), __args);
			} finally {
				if (p0 != null) {
					JNIEnv.CopyArray (native_p0, p0);
					JNIEnv.DeleteLocalRef (native_p0);
		...
		static Delegate cb_addRow_Lorg_neuroph_core_learning_DataSetRow_;
#pragma warning disable 0169
		static Delegate GetAddRow_Lorg_neuroph_core_learning_DataSetRow_Handler ()
		{
			if (cb_addRow_Lorg_neuroph_core_learning_DataSetRow_ == null)
				cb_addRow_Lorg_neuroph_core_learning_DataSetRow_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_AddRow_Lorg_neuroph_core_learning_DataSetRow_);
			return cb_addRow_Lorg_neuroph_core_learning_DataSetRow_;
		}

		static void n_AddRow_Lorg_neuroph_core_learning_DataSetRow_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Org.Neuroph.Core.Learning.DataSet __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.DataSet> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		static IntPtr id_addRow_Lorg_neuroph_core_learning_DataSetRow_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='addRow' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.learning.DataSetRow']]"
		[Register ("addRow", "(Lorg/neuroph/core/learning/DataSetRow;)V", "GetAddRow_Lorg_neuroph_core_learning_DataSetRow_Handler")]
		public virtual unsafe void AddRow (global::Org.Neuroph.Core.Learning.DataSetRow p0)
		{
			if (id_addRow_Lorg_neuroph_core_learning_DataSetRow_ == IntPtr.Zero)
				id_addRow_Lorg_neuroph_core_learning_DataSetRow_ = JNIEnv.GetMethodID (class_ref, "addRow", "(Lorg/neuroph/core/learning/DataSetRow;)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_addRow_Lorg_neuroph_core_learning_DataSetRow_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "addRow", "(Lorg/neuroph/core/learning/DataSetRow;)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='clear' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='createFromFile' and count(parameter)=4 and parameter[1][@type='java.lang.String'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='java.lang.String']]"
		[Register ("createFromFile", "(Ljava/lang/String;IILjava/lang/String;)Lorg/neuroph/core/learning/DataSet;", "")]
		public static unsafe global::Org.Neuroph.Core.Learning.DataSet CreateFromFile (string p0, int p1, int p2, string p3)
		{
			if (id_createFromFile_Ljava_lang_String_IILjava_lang_String_ == IntPtr.Zero)
				id_createFromFile_Ljava_lang_String_IILjava_lang_String_ = JNIEnv.GetStaticMethodID (class_ref, "createFromFile", "(Ljava/lang/String;IILjava/lang/String;)Lorg/neuroph/core/learning/DataSet;");
			...
			try {
				...
				global::Org.Neuroph.Core.Learning.DataSet __ret = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.DataSet> (JNIEnv.CallStaticObjectMethod  (class_ref, id_createFromFile_Ljava_lang_String_IILjava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='createTrainingAndTestSubsets' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
		[Register ("createTrainingAndTestSubsets", "(II)[Lorg/neuroph/core/learning/DataSet;", "GetCreateTrainingAndTestSubsets_IIHandler")]
		public virtual unsafe global::Org.Neuroph.Core.Learning.DataSet[] CreateTrainingAndTestSubsets (int p0, int p1)
		{
			if (id_createTrainingAndTestSubsets_II == IntPtr.Zero)
				id_createTrainingAndTestSubsets_II = JNIEnv.GetMethodID (class_ref, "createTrainingAndTestSubsets", "(II)[Lorg/neuroph/core/learning/DataSet;");
			try {
				JValue* __args = stackalloc JValue [2];
				__args [0] = new JValue (p0);
				__args [1] = new JValue (p1);
				...
				if (GetType () == ThresholdType)
					return (global::Org.Neuroph.Core.Learning.DataSet[]) JNIEnv.GetArray (JNIEnv.CallObjectMethod  (Handle, id_createTrainingAndTestSubsets_II, __args), JniHandleOwnership.TransferLocalRef, typeof (global::Org.Neuroph.Core.Learning.DataSet));
				else
					return (global::Org.Neuroph.Core.Learning.DataSet[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "createTrainingAndTestSubsets", "(II)[Lorg/neuroph/core/learning/DataSet;"), __args), JniHandleOwnership.TransferLocalRef, typeof (global::Org.Neuroph.Core.Learning.DataSet));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='getColumnNames' and count(parameter)=0]"
		...
		public virtual unsafe string[] GetColumnNames ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					return (string[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getColumnNames", "()[Ljava/lang/String;")), JniHandleOwnership.TransferLocalRef, typeof (string));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='getRowAt' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("getRowAt", "(I)Lorg/neuroph/core/learning/DataSetRow;", "GetGetRowAt_IHandler")]
		public virtual unsafe global::Org.Neuroph.Core.Learning.DataSetRow GetRowAt (int p0)
		{
			if (id_getRowAt_I == IntPtr.Zero)
				id_getRowAt_I = JNIEnv.GetMethodID (class_ref, "getRowAt", "(I)Lorg/neuroph/core/learning/DataSetRow;");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);

				if (GetType () == ThresholdType)
					return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.DataSetRow> (JNIEnv.CallObjectMethod  (Handle, id_getRowAt_I, __args), JniHandleOwnership.TransferLocalRef);
				else
					return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.DataSetRow> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getRowAt", "(I)Lorg/neuroph/core/learning/DataSetRow;"), __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='iterator' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='load' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("load", "(Ljava/lang/String;)Lorg/neuroph/core/learning/DataSet;", "")]
		public static unsafe global::Org.Neuroph.Core.Learning.DataSet Load (string p0)
		{
			if (id_load_Ljava_lang_String_ == IntPtr.Zero)
				id_load_Ljava_lang_String_ = JNIEnv.GetStaticMethodID (class_ref, "load", "(Ljava/lang/String;)Lorg/neuroph/core/learning/DataSet;");
			IntPtr native_p0 = JNIEnv.NewString (p0);
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (native_p0);
				global::Org.Neuroph.Core.Learning.DataSet __ret = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.DataSet> (JNIEnv.CallStaticObjectMethod  (class_ref, id_load_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
			}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='normalize' and count(parameter)=0]"
		...
		static Delegate cb_normalize_Lorg_neuroph_util_norm_Normalizer_;
#pragma warning disable 0169
		static Delegate GetNormalize_Lorg_neuroph_util_norm_Normalizer_Handler ()
		{
			if (cb_normalize_Lorg_neuroph_util_norm_Normalizer_ == null)
				cb_normalize_Lorg_neuroph_util_norm_Normalizer_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_Normalize_Lorg_neuroph_util_norm_Normalizer_);
			return cb_normalize_Lorg_neuroph_util_norm_Normalizer_;
		}

		static void n_Normalize_Lorg_neuroph_util_norm_Normalizer_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Org.Neuroph.Core.Learning.DataSet __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.DataSet> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Org.Neuroph.Util.Norm.INormalizer p0 = (global::Org.Neuroph.Util.Norm.INormalizer)global::Java.Lang.Object.GetObject<global::Org.Neuroph.Util.Norm.INormalizer> (native_p0, JniHandleOwnership.DoNotTransfer);
			__this.Normalize (p0);
		}
#pragma warning restore 0169

		static IntPtr id_normalize_Lorg_neuroph_util_norm_Normalizer_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='normalize' and count(parameter)=1 and parameter[1][@type='org.neuroph.util.norm.Normalizer']]"
		[Register ("normalize", "(Lorg/neuroph/util/norm/Normalizer;)V", "GetNormalize_Lorg_neuroph_util_norm_Normalizer_Handler")]
		public virtual unsafe void Normalize (global::Org.Neuroph.Util.Norm.INormalizer p0)
		{
			if (id_normalize_Lorg_neuroph_util_norm_Normalizer_ == IntPtr.Zero)
				id_normalize_Lorg_neuroph_util_norm_Normalizer_ = JNIEnv.GetMethodID (class_ref, "normalize", "(Lorg/neuroph/util/norm/Normalizer;)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_normalize_Lorg_neuroph_util_norm_Normalizer_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "normalize", "(Lorg/neuroph/util/norm/Normalizer;)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='removeRowAt' and count(parameter)=1 and parameter[1][@type='int']]"
		...
		public virtual unsafe void RemoveRowAt (int p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_removeRowAt_I, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "removeRowAt", "(I)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='save' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='save' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='saveAsTxt' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
		...
		public virtual unsafe void SaveAsTxt (string p0, string p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_saveAsTxt_Ljava_lang_String_Ljava_lang_String_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "saveAsTxt", "(Ljava/lang/String;Ljava/lang/String;)V"), __args);
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
				JNIEnv.DeleteLocalRef (native_p1);
			}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='setColumnNames' and count(parameter)=1 and parameter[1][@type='java.lang.String[]']]"
		...
		public virtual unsafe void SetColumnNames (string[] p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setColumnNames_arrayLjava_lang_String_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setColumnNames", "([Ljava/lang/String;)V"), __args);
			} finally {
				if (p0 != null) {
					JNIEnv.CopyArray (native_p0, p0);
					JNIEnv.DeleteLocalRef (native_p0);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='shuffle' and count(parameter)=0]"
		...
		public virtual unsafe void Shuffle ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_shuffle);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "shuffle", "()V"));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='DataSet']/method[@name='size' and count(parameter)=0]"
