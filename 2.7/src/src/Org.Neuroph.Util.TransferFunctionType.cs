...
namespace Org.Neuroph.Util {
	...
	public sealed partial class TransferFunctionType : global::Java.Lang.Enum {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='org.neuroph.util']/class[@name='TransferFunctionType']/field[@name='LOG']"
		[Register ("LOG")]
		public static global::Org.Neuroph.Util.TransferFunctionType Log {
			get {
				if (LOG_jfieldId == IntPtr.Zero)
					LOG_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "LOG", "Lorg/neuroph/util/TransferFunctionType;");
		...
		static IntPtr SIN_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='org.neuroph.util']/class[@name='TransferFunctionType']/field[@name='SIN']"
		[Register ("SIN")]
		public static global::Org.Neuroph.Util.TransferFunctionType Sin {
			get {
				if (SIN_jfieldId == IntPtr.Zero)
					SIN_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "SIN", "Lorg/neuroph/util/TransferFunctionType;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, SIN_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Util.TransferFunctionType> (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}
