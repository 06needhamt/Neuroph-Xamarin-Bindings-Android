			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (NeuralNetworkEvent)) {
					...
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Lorg/neuroph/core/Layer;Lorg/neuroph/core/events/NeuralNetworkEventType;)V", __args);
					return;
				}
				...
				SetHandle (
						...
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lorg_neuroph_core_Layer_Lorg_neuroph_core_events_NeuralNetworkEventType_, __args);
			} finally {
			}
		}
			...
			try {
				...
				if (GetType () != typeof (NeuralNetworkEvent)) {
					SetHandle (
							...
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Lorg/neuroph/core/NeuralNetwork;Lorg/neuroph/core/events/NeuralNetworkEventType;)V", __args);
					return;
				}
				...
				SetHandle (
						...
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lorg_neuroph_core_NeuralNetwork_Lorg_neuroph_core_events_NeuralNetworkEventType_, __args);
			} finally {
			}
		}
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Events.NeuralNetworkEventType> (JNIEnv.CallObjectMethod  (Handle, id_getEventType), JniHandleOwnership.TransferLocalRef);
					else
						return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Events.NeuralNetworkEventType> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getEventType", "()Lorg/neuroph/core/events/NeuralNetworkEventType;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
