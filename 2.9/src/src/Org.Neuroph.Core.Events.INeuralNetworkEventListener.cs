...
namespace Org.Neuroph.Core.Events {
	...
	public partial interface INeuralNetworkEventListener : global::Java.Util.IEventListener {
		...
		[Register ("handleNeuralNetworkEvent", "(Lorg/neuroph/core/events/NeuralNetworkEvent;)V", "GetHandleNeuralNetworkEvent_Lorg_neuroph_core_events_NeuralNetworkEvent_Handler:Org.Neuroph.Core.Events.INeuralNetworkEventListenerInvoker, neuroph_2.9")]
