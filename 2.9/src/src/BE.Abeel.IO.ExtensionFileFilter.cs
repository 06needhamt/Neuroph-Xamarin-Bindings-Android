...
namespace BE.Abeel.IO {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='be.abeel.io']/class[@name='ExtensionFileFilter']"
	[global::Android.Runtime.Register ("be/abeel/io/ExtensionFileFilter", DoNotGenerateAcw=true)]
	public partial class ExtensionFileFilter : global::Java.Lang.Object, global::Java.IO.IFileFilter {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("be/abeel/io/ExtensionFileFilter", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ExtensionFileFilter); }
		}

		protected ExtensionFileFilter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='be.abeel.io']/class[@name='ExtensionFileFilter']/constructor[@name='ExtensionFileFilter' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe ExtensionFileFilter (string p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (ExtensionFileFilter)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='be.abeel.io']/class[@name='ExtensionFileFilter']/constructor[@name='ExtensionFileFilter' and count(parameter)=1 and parameter[1][@type='java.util.List&lt;java.lang.String&gt;']]"
		[Register (".ctor", "(Ljava/util/List;)V", "")]
		public unsafe ExtensionFileFilter (global::System.Collections.Generic.IList<string> p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::BE.Abeel.IO.ExtensionFileFilter __this = global::Java.Lang.Object.GetObject<global::BE.Abeel.IO.ExtensionFileFilter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='be.abeel.io']/class[@name='ExtensionFileFilter']/method[@name='accept' and count(parameter)=1 and parameter[1][@type='java.io.File']]"
