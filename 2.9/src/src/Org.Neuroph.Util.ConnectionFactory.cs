...
namespace Org.Neuroph.Util {
	...
	public partial class ConnectionFactory : global::Java.Lang.Object {
		...
		static IntPtr id_createConnection_Lorg_neuroph_core_Neuron_Lorg_neuroph_core_Layer_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.util']/class[@name='ConnectionFactory']/method[@name='createConnection' and count(parameter)=2 and parameter[1][@type='org.neuroph.core.Neuron'] and parameter[2][@type='org.neuroph.core.Layer']]"
		[Register ("createConnection", "(Lorg/neuroph/core/Neuron;Lorg/neuroph/core/Layer;)V", "")]
