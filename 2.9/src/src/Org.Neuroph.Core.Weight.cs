...
#pragma warning restore 0169
		...
		public virtual unsafe void Randomize (global::Java.Util.Random p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_randomize_Ljava_util_Random_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "randomize", "(Ljava/util/Random;)V"), __args);
			} finally {
			}
		}
