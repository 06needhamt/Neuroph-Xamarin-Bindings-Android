...
namespace Org.Neuroph.Nnet.Comp.Layer {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.nnet.comp.layer']/class[@name='PoolingLayer']"
	[global::Android.Runtime.Register ("org/neuroph/nnet/comp/layer/PoolingLayer", DoNotGenerateAcw=true)]
	public partial class PoolingLayer : global::Org.Neuroph.Nnet.Comp.Layer.FeatureMapsLayer {


		static IntPtr DEFAULT_NEURON_PROP_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='org.neuroph.nnet.comp.layer']/class[@name='PoolingLayer']/field[@name='DEFAULT_NEURON_PROP']"
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/nnet/comp/layer/PoolingLayer", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (PoolingLayer); }
		}

		protected PoolingLayer (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lorg_neuroph_nnet_comp_layer_FeatureMapsLayer_Lorg_neuroph_nnet_comp_Kernel_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.nnet.comp.layer']/class[@name='PoolingLayer']/constructor[@name='PoolingLayer' and count(parameter)=2 and parameter[1][@type='org.neuroph.nnet.comp.layer.FeatureMapsLayer'] and parameter[2][@type='org.neuroph.nnet.comp.Kernel']]"
		[Register (".ctor", "(Lorg/neuroph/nnet/comp/layer/FeatureMapsLayer;Lorg/neuroph/nnet/comp/Kernel;)V", "")]
		public unsafe PoolingLayer (global::Org.Neuroph.Nnet.Comp.Layer.FeatureMapsLayer p0, global::Org.Neuroph.Nnet.Comp.Kernel p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (PoolingLayer)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.nnet.comp.layer']/class[@name='PoolingLayer']/constructor[@name='PoolingLayer' and count(parameter)=4 and parameter[1][@type='org.neuroph.nnet.comp.layer.FeatureMapsLayer'] and parameter[2][@type='org.neuroph.nnet.comp.Kernel'] and parameter[3][@type='int'] and parameter[4][@type='org.neuroph.util.NeuronProperties']]"
		...
		public unsafe PoolingLayer (global::Org.Neuroph.Nnet.Comp.Layer.FeatureMapsLayer p0, global::Org.Neuroph.Nnet.Comp.Kernel p1, int p2, global::Org.Neuroph.Util.NeuronProperties p3)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
