...
namespace Org.Neuroph.Util.IO {
	...
	public partial interface IInputAdapter : IJavaObject {
		...
		[Register ("close", "()V", "GetCloseHandler:Org.Neuroph.Util.IO.IInputAdapterInvoker, neuroph_2.9")]
		void Close ();
		...
		[Register ("readInput", "()[D", "GetReadInputHandler:Org.Neuroph.Util.IO.IInputAdapterInvoker, neuroph_2.9")]
		double[] ReadInput ();
