...
namespace Org.Neuroph.Nnet.Comp.Layer {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.nnet.comp.layer']/class[@name='CompetitiveLayer']"
	[global::Android.Runtime.Register ("org/neuroph/nnet/comp/layer/CompetitiveLayer", DoNotGenerateAcw=true)]
	public partial class CompetitiveLayer : global::Org.Neuroph.Core.Layer {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/nnet/comp/layer/CompetitiveLayer", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.nnet.comp.layer']/class[@name='CompetitiveLayer']/constructor[@name='CompetitiveLayer' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='org.neuroph.util.NeuronProperties']]"
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Nnet.Comp.Layer.CompetitiveLayer __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Nnet.Comp.Layer.CompetitiveLayer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe int MaxIterations {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.nnet.comp.layer']/class[@name='CompetitiveLayer']/method[@name='getMaxIterations' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.nnet.comp.layer']/class[@name='CompetitiveLayer']/method[@name='setMaxIterations' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Org.Neuroph.Nnet.Comp.Neuron.CompetitiveNeuron Winner {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.nnet.comp.layer']/class[@name='CompetitiveLayer']/method[@name='getWinner' and count(parameter)=0]"
			[Register ("getWinner", "()Lorg/neuroph/nnet/comp/neuron/CompetitiveNeuron;", "GetGetWinnerHandler")]
			get {
				if (id_getWinner == IntPtr.Zero)
					id_getWinner = JNIEnv.GetMethodID (class_ref, "getWinner", "()Lorg/neuroph/nnet/comp/neuron/CompetitiveNeuron;");
				try {

					if (GetType () == ThresholdType)
						return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Nnet.Comp.Neuron.CompetitiveNeuron> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getWinner), JniHandleOwnership.TransferLocalRef);
					else
						return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Nnet.Comp.Neuron.CompetitiveNeuron> (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getWinner", "()Lorg/neuroph/nnet/comp/neuron/CompetitiveNeuron;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
