	...
	public abstract partial class SupervisedLearning : global::Org.Neuroph.Core.Learning.IterativeLearning, global::Java.IO.ISerializable {
		...
		protected double TotalSquaredErrorSum {
			get {
				...
				return JNIEnv.GetDoubleField (((global::Java.Lang.Object) this).Handle, totalSquaredErrorSum_jfieldId);
			}
			set {
				if (totalSquaredErrorSum_jfieldId == IntPtr.Zero)
					totalSquaredErrorSum_jfieldId = JNIEnv.GetFieldID (class_ref, "totalSquaredErrorSum", "D");
				try {
					JNIEnv.SetField (((global::Java.Lang.Object) this).Handle, totalSquaredErrorSum_jfieldId, value);
				} finally {
				}
			}
		}
		...
		static Delegate cb_getErrorFunction;
#pragma warning disable 0169
		static Delegate GetGetErrorFunctionHandler ()
		{
			if (cb_getErrorFunction == null)
				cb_getErrorFunction = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetErrorFunction);
			return cb_getErrorFunction;
		}

		static IntPtr n_GetErrorFunction (IntPtr jnienv, IntPtr native__this)
		{
			...
			return JNIEnv.ToLocalJniHandle (__this.ErrorFunction);
		}
#pragma warning restore 0169

		static Delegate cb_setErrorFunction_Lorg_neuroph_core_learning_error_ErrorFunction_;
#pragma warning disable 0169
		static Delegate GetSetErrorFunction_Lorg_neuroph_core_learning_error_ErrorFunction_Handler ()
		{
			if (cb_setErrorFunction_Lorg_neuroph_core_learning_error_ErrorFunction_ == null)
				cb_setErrorFunction_Lorg_neuroph_core_learning_error_ErrorFunction_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_SetErrorFunction_Lorg_neuroph_core_learning_error_ErrorFunction_);
			return cb_setErrorFunction_Lorg_neuroph_core_learning_error_ErrorFunction_;
		}

		static void n_SetErrorFunction_Lorg_neuroph_core_learning_error_ErrorFunction_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Org.Neuroph.Core.Learning.SupervisedLearning __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.SupervisedLearning> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Org.Neuroph.Core.Learning.Error.IErrorFunction p0 = (global::Org.Neuroph.Core.Learning.Error.IErrorFunction)global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.Error.IErrorFunction> (native_p0, JniHandleOwnership.DoNotTransfer);
			__this.ErrorFunction = p0;
		}
#pragma warning restore 0169

		static IntPtr id_getErrorFunction;
		static IntPtr id_setErrorFunction_Lorg_neuroph_core_learning_error_ErrorFunction_;
		public virtual unsafe global::Org.Neuroph.Core.Learning.Error.IErrorFunction ErrorFunction {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='SupervisedLearning']/method[@name='getErrorFunction' and count(parameter)=0]"
			[Register ("getErrorFunction", "()Lorg/neuroph/core/learning/error/ErrorFunction;", "GetGetErrorFunctionHandler")]
			get {
				if (id_getErrorFunction == IntPtr.Zero)
					id_getErrorFunction = JNIEnv.GetMethodID (class_ref, "getErrorFunction", "()Lorg/neuroph/core/learning/error/ErrorFunction;");
				try {

					if (GetType () == ThresholdType)
						return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.Error.IErrorFunction> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getErrorFunction), JniHandleOwnership.TransferLocalRef);
					else
						return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.Error.IErrorFunction> (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getErrorFunction", "()Lorg/neuroph/core/learning/error/ErrorFunction;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
			// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='SupervisedLearning']/method[@name='setErrorFunction' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.learning.error.ErrorFunction']]"
			[Register ("setErrorFunction", "(Lorg/neuroph/core/learning/error/ErrorFunction;)V", "GetSetErrorFunction_Lorg_neuroph_core_learning_error_ErrorFunction_Handler")]
			set {
				if (id_setErrorFunction_Lorg_neuroph_core_learning_error_ErrorFunction_ == IntPtr.Zero)
					id_setErrorFunction_Lorg_neuroph_core_learning_error_ErrorFunction_ = JNIEnv.GetMethodID (class_ref, "setErrorFunction", "(Lorg/neuroph/core/learning/error/ErrorFunction;)V");
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (value);

					if (GetType () == ThresholdType)
						JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_setErrorFunction_Lorg_neuroph_core_learning_error_ErrorFunction_, __args);
					else
						JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setErrorFunction", "(Lorg/neuroph/core/learning/error/ErrorFunction;)V"), __args);
				} finally {
				}
			}
		}
		...
		public virtual unsafe bool IsInBatchMode {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_isInBatchMode);
					else
						return JNIEnv.CallNonvirtualBooleanMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "isInBatchMode", "()Z"));
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		protected virtual unsafe void AddToSquaredErrorSum (double[] p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_addToSquaredErrorSum_arrayD, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "addToSquaredErrorSum", "([D)V"), __args);
			} finally {
				if (p0 != null) {
...
#pragma warning restore 0169
		...
		protected virtual unsafe double[] CalculateOutputError (double[] p0, double[] p1)
		{
			...
			try {
				...
				double[] __ret;
				if (GetType () == ThresholdType)
					__ret = (double[]) JNIEnv.GetArray (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_calculateOutputError_arrayDarrayD, __args), JniHandleOwnership.TransferLocalRef, typeof (double));
				else
					__ret = (double[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "calculateOutputError", "([D[D)[D"), __args), JniHandleOwnership.TransferLocalRef, typeof (double));
				return __ret;
			} finally {
				if (p0 != null) {
					JNIEnv.CopyArray (native_p0, p0);
...
#pragma warning restore 0169
		...
		protected virtual unsafe void DoBatchWeightsUpdate ()
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_doBatchWeightsUpdate);
				else
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "doBatchWeightsUpdate", "()V"));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='SupervisedLearning']/method[@name='doLearningEpoch' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.data.DataSet']]"
		...
		static Delegate cb_learn_Lorg_neuroph_core_data_DataSet_D;
#pragma warning disable 0169
		static Delegate GetLearn_Lorg_neuroph_core_data_DataSet_DHandler ()
		{
			if (cb_learn_Lorg_neuroph_core_data_DataSet_D == null)
				cb_learn_Lorg_neuroph_core_data_DataSet_D = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr, double>) n_Learn_Lorg_neuroph_core_data_DataSet_D);
			return cb_learn_Lorg_neuroph_core_data_DataSet_D;
		}

		static void n_Learn_Lorg_neuroph_core_data_DataSet_D (IntPtr jnienv, IntPtr native__this, IntPtr native_p0, double p1)
		{
			global::Org.Neuroph.Core.Learning.SupervisedLearning __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.SupervisedLearning> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Org.Neuroph.Core.Data.DataSet p0 = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Data.DataSet> (native_p0, JniHandleOwnership.DoNotTransfer);
			__this.Learn (p0, p1);
...
#pragma warning restore 0169
		...
		static IntPtr id_learn_Lorg_neuroph_core_data_DataSet_D;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='SupervisedLearning']/method[@name='learn' and count(parameter)=2 and parameter[1][@type='org.neuroph.core.data.DataSet'] and parameter[2][@type='double']]"
		[Register ("learn", "(Lorg/neuroph/core/data/DataSet;D)V", "GetLearn_Lorg_neuroph_core_data_DataSet_DHandler")]
		...
		static Delegate cb_learn_Lorg_neuroph_core_data_DataSet_DI;
#pragma warning disable 0169
		static Delegate GetLearn_Lorg_neuroph_core_data_DataSet_DIHandler ()
		{
			if (cb_learn_Lorg_neuroph_core_data_DataSet_DI == null)
				cb_learn_Lorg_neuroph_core_data_DataSet_DI = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr, double, int>) n_Learn_Lorg_neuroph_core_data_DataSet_DI);
			return cb_learn_Lorg_neuroph_core_data_DataSet_DI;
		}

		static void n_Learn_Lorg_neuroph_core_data_DataSet_DI (IntPtr jnienv, IntPtr native__this, IntPtr native_p0, double p1, int p2)
		{
			global::Org.Neuroph.Core.Learning.SupervisedLearning __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Learning.SupervisedLearning> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Org.Neuroph.Core.Data.DataSet p0 = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Data.DataSet> (native_p0, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		static IntPtr id_learn_Lorg_neuroph_core_data_DataSet_DI;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='SupervisedLearning']/method[@name='learn' and count(parameter)=3 and parameter[1][@type='org.neuroph.core.data.DataSet'] and parameter[2][@type='double'] and parameter[3][@type='int']]"
		[Register ("learn", "(Lorg/neuroph/core/data/DataSet;DI)V", "GetLearn_Lorg_neuroph_core_data_DataSet_DIHandler")]
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.learning']/class[@name='SupervisedLearning']/method[@name='learnPattern' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.data.DataSetRow']]"
