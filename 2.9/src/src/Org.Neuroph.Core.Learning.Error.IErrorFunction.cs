...
namespace Org.Neuroph.Core.Learning.Error {
	...
	public partial interface IErrorFunction : IJavaObject {
		...
		double TotalError {
			...
			[Register ("getTotalError", "()D", "GetGetTotalErrorHandler:Org.Neuroph.Core.Learning.Error.IErrorFunctionInvoker, neuroph_2.9")] get;
		}
		...
		[Register ("addOutputError", "([D)V", "GetAddOutputError_arrayDHandler:Org.Neuroph.Core.Learning.Error.IErrorFunctionInvoker, neuroph_2.9")]
		...
		[Register ("reset", "()V", "GetResetHandler:Org.Neuroph.Core.Learning.Error.IErrorFunctionInvoker, neuroph_2.9")]
		void Reset ();
