...
namespace Org.Neuroph.Samples.Uci {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.neuroph.samples.uci']/class[@name='ConceptLearningAndClassificationSample']"
	[global::Android.Runtime.Register ("org/neuroph/samples/uci/ConceptLearningAndClassificationSample", DoNotGenerateAcw=true)]
	public partial class ConceptLearningAndClassificationSample : global::Java.Lang.Object, global::Org.Neuroph.Core.Events.ILearningEventListener {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/neuroph/samples/uci/ConceptLearningAndClassificationSample", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ConceptLearningAndClassificationSample); }
		}

		protected ConceptLearningAndClassificationSample (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.neuroph.samples.uci']/class[@name='ConceptLearningAndClassificationSample']/constructor[@name='ConceptLearningAndClassificationSample' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ConceptLearningAndClassificationSample ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (ConceptLearningAndClassificationSample)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Org.Neuroph.Samples.Uci.ConceptLearningAndClassificationSample __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Samples.Uci.ConceptLearningAndClassificationSample> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.uci']/class[@name='ConceptLearningAndClassificationSample']/method[@name='handleLearningEvent' and count(parameter)=1 and parameter[1][@type='org.neuroph.core.events.LearningEvent']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.uci']/class[@name='ConceptLearningAndClassificationSample']/method[@name='main' and count(parameter)=1 and parameter[1][@type='java.lang.String[]']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.uci']/class[@name='ConceptLearningAndClassificationSample']/method[@name='run' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.samples.uci']/class[@name='ConceptLearningAndClassificationSample']/method[@name='testNeuralNetwork' and count(parameter)=2 and parameter[1][@type='org.neuroph.core.NeuralNetwork'] and parameter[2][@type='org.neuroph.core.data.DataSet']]"
