		...
		public virtual unsafe global::System.Collections.Generic.IList<global::Org.Neuroph.Core.Data.DataSetRow> Rows {
			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return global::Android.Runtime.JavaList<global::Org.Neuroph.Core.Data.DataSetRow>.FromJniHandle (JNIEnv.CallObjectMethod  (Handle, id_getRows), JniHandleOwnership.TransferLocalRef);
					else
						return global::Android.Runtime.JavaList<global::Org.Neuroph.Core.Data.DataSetRow>.FromJniHandle (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getRows", "()Ljava/util/List;")), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void AddRow (global::Org.Neuroph.Core.Data.DataSetRow p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_addRow_Lorg_neuroph_core_data_DataSetRow_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "addRow", "(Lorg/neuroph/core/data/DataSetRow;)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		static IntPtr id_createFromFile_Ljava_lang_String_IILjava_lang_String_Z;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.data']/class[@name='DataSet']/method[@name='createFromFile' and count(parameter)=5 and parameter[1][@type='java.lang.String'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='java.lang.String'] and parameter[5][@type='boolean']]"
		[Register ("createFromFile", "(Ljava/lang/String;IILjava/lang/String;Z)Lorg/neuroph/core/data/DataSet;", "")]
		public static unsafe global::Org.Neuroph.Core.Data.DataSet CreateFromFile (string p0, int p1, int p2, string p3, bool p4)
		{
			if (id_createFromFile_Ljava_lang_String_IILjava_lang_String_Z == IntPtr.Zero)
				id_createFromFile_Ljava_lang_String_IILjava_lang_String_Z = JNIEnv.GetStaticMethodID (class_ref, "createFromFile", "(Ljava/lang/String;IILjava/lang/String;Z)Lorg/neuroph/core/data/DataSet;");
			...
			try {
				...
				global::Org.Neuroph.Core.Data.DataSet __ret = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Data.DataSet> (JNIEnv.CallStaticObjectMethod  (class_ref, id_createFromFile_Ljava_lang_String_IILjava_lang_String_Z, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Org.Neuroph.Core.Data.DataSet[] CreateTrainingAndTestSubsets (int p0, int p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return (global::Org.Neuroph.Core.Data.DataSet[]) JNIEnv.GetArray (JNIEnv.CallObjectMethod  (Handle, id_createTrainingAndTestSubsets_II, __args), JniHandleOwnership.TransferLocalRef, typeof (global::Org.Neuroph.Core.Data.DataSet));
				else
					return (global::Org.Neuroph.Core.Data.DataSet[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "createTrainingAndTestSubsets", "(II)[Lorg/neuroph/core/data/DataSet;"), __args), JniHandleOwnership.TransferLocalRef, typeof (global::Org.Neuroph.Core.Data.DataSet));
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe string GetColumnName (int p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return JNIEnv.GetString (JNIEnv.CallObjectMethod  (Handle, id_getColumnName_I, __args), JniHandleOwnership.TransferLocalRef);
				else
					return JNIEnv.GetString (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getColumnName", "(I)Ljava/lang/String;"), __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Org.Neuroph.Core.Data.DataSetRow GetRowAt (int p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Data.DataSetRow> (JNIEnv.CallObjectMethod  (Handle, id_getRowAt_I, __args), JniHandleOwnership.TransferLocalRef);
				else
					return global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Data.DataSetRow> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getRowAt", "(I)Lorg/neuroph/core/data/DataSetRow;"), __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Org.Neuroph.Core.Data.DataSet[] Sample (int p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return (global::Org.Neuroph.Core.Data.DataSet[]) JNIEnv.GetArray (JNIEnv.CallObjectMethod  (Handle, id_sample_I, __args), JniHandleOwnership.TransferLocalRef, typeof (global::Org.Neuroph.Core.Data.DataSet));
				else
					return (global::Org.Neuroph.Core.Data.DataSet[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "sample", "(I)[Lorg/neuroph/core/data/DataSet;"), __args), JniHandleOwnership.TransferLocalRef, typeof (global::Org.Neuroph.Core.Data.DataSet));
			} finally {
			}
		}

		static Delegate cb_sample_Lorg_neuroph_util_data_sample_Sampling_;
#pragma warning disable 0169
		static Delegate GetSample_Lorg_neuroph_util_data_sample_Sampling_Handler ()
		{
			if (cb_sample_Lorg_neuroph_util_data_sample_Sampling_ == null)
				cb_sample_Lorg_neuroph_util_data_sample_Sampling_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr>) n_Sample_Lorg_neuroph_util_data_sample_Sampling_);
			return cb_sample_Lorg_neuroph_util_data_sample_Sampling_;
		}

		static IntPtr n_Sample_Lorg_neuroph_util_data_sample_Sampling_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Org.Neuroph.Core.Data.DataSet __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Data.DataSet> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			global::Org.Neuroph.Util.Data.Sample.ISampling p0 = (global::Org.Neuroph.Util.Data.Sample.ISampling)global::Java.Lang.Object.GetObject<global::Org.Neuroph.Util.Data.Sample.ISampling> (native_p0, JniHandleOwnership.DoNotTransfer);
			IntPtr __ret = JNIEnv.NewArray (__this.Sample (p0));
			return __ret;
		}
#pragma warning restore 0169

		static IntPtr id_sample_Lorg_neuroph_util_data_sample_Sampling_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.data']/class[@name='DataSet']/method[@name='sample' and count(parameter)=1 and parameter[1][@type='org.neuroph.util.data.sample.Sampling']]"
		[Register ("sample", "(Lorg/neuroph/util/data/sample/Sampling;)[Lorg/neuroph/core/data/DataSet;", "GetSample_Lorg_neuroph_util_data_sample_Sampling_Handler")]
		public virtual unsafe global::Org.Neuroph.Core.Data.DataSet[] Sample (global::Org.Neuroph.Util.Data.Sample.ISampling p0)
		{
			if (id_sample_Lorg_neuroph_util_data_sample_Sampling_ == IntPtr.Zero)
				id_sample_Lorg_neuroph_util_data_sample_Sampling_ = JNIEnv.GetMethodID (class_ref, "sample", "(Lorg/neuroph/util/data/sample/Sampling;)[Lorg/neuroph/core/data/DataSet;");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				...
				if (GetType () == ThresholdType)
					__ret = (global::Org.Neuroph.Core.Data.DataSet[]) JNIEnv.GetArray (JNIEnv.CallObjectMethod  (Handle, id_sample_Lorg_neuroph_util_data_sample_Sampling_, __args), JniHandleOwnership.TransferLocalRef, typeof (global::Org.Neuroph.Core.Data.DataSet));
				else
					__ret = (global::Org.Neuroph.Core.Data.DataSet[]) JNIEnv.GetArray (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "sample", "(Lorg/neuroph/util/data/sample/Sampling;)[Lorg/neuroph/core/data/DataSet;"), __args), JniHandleOwnership.TransferLocalRef, typeof (global::Org.Neuroph.Core.Data.DataSet));
				return __ret;
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		static Delegate cb_setColumnName_ILjava_lang_String_;
#pragma warning disable 0169
		static Delegate GetSetColumnName_ILjava_lang_String_Handler ()
		{
			if (cb_setColumnName_ILjava_lang_String_ == null)
				cb_setColumnName_ILjava_lang_String_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, int, IntPtr>) n_SetColumnName_ILjava_lang_String_);
			return cb_setColumnName_ILjava_lang_String_;
		}

		static void n_SetColumnName_ILjava_lang_String_ (IntPtr jnienv, IntPtr native__this, int p0, IntPtr native_p1)
		{
			global::Org.Neuroph.Core.Data.DataSet __this = global::Java.Lang.Object.GetObject<global::Org.Neuroph.Core.Data.DataSet> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			string p1 = JNIEnv.GetString (native_p1, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		static IntPtr id_setColumnName_ILjava_lang_String_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.neuroph.core.data']/class[@name='DataSet']/method[@name='setColumnName' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='java.lang.String']]"
		[Register ("setColumnName", "(ILjava/lang/String;)V", "GetSetColumnName_ILjava_lang_String_Handler")]
		public virtual unsafe void SetColumnName (int p0, string p1)
		{
			if (id_setColumnName_ILjava_lang_String_ == IntPtr.Zero)
				id_setColumnName_ILjava_lang_String_ = JNIEnv.GetMethodID (class_ref, "setColumnName", "(ILjava/lang/String;)V");
			IntPtr native_p1 = JNIEnv.NewString (p1);
			try {
				JValue* __args = stackalloc JValue [2];
				__args [0] = new JValue (p0);
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setColumnName_ILjava_lang_String_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setColumnName", "(ILjava/lang/String;)V"), __args);
			} finally {
				JNIEnv.DeleteLocalRef (native_p1);
			}
		}
